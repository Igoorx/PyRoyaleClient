...
function Menu() {
    ...
    window.onpopstate = function(screens) {
        ...
        else screens.state && "Infringe Royale" !== screens.state.pageTitle ? (document.getElementById("content").innerHTML = screens.state.html, document.title = screens.state.pageTitle) : screens.state && "Infringe Royale" === screens.state.pageTitle && window.history.back();
    };
    this.hideAll();
    this.background('c');
...
Net.prototype.connect = function(name, team, priv) {
    var _0x14cb96 = WEBSOCKET_SERVER;//window.location.host;
    this.prefName = name;
    this.prefTeam = team;
    this.isPrivate = priv;
    var net = this;
    this.connected() ? gameClient.menu.error.show("Connection already open. State error.") : (this.webSocket = new WebSocket("ws://" + _0x14cb96 + "/royale/ws"), this.webSocket.binaryType = "arraybuffer", this.webSocket.onopen = function(name) {
...
Net.prototype.handlePacket = function(_0x28f70a) {
    if (void 0x0 === this.state || !this.state.handlePacket(_0x28f70a)) switch (_0x28f70a.type) {
        ...
        case "s02":
            break;
        case "x00":
            gameClient.menu.error.show("Server Exception", _0x28f70a.message);
            break;
        case "x01":
            gameClient.menu.error.show("Server Exception", _0x28f70a.message, _0x28f70a.trace);
            break;
        default:
            gameClient.menu.error.show("Recieved invalid packet type: " + _0x28f70a.type, JSON.stringify(_0x28f70a));
    }
};
Net.prototype.handleBinary = function(_0x5424b1) {
    this.state.handleBinary(_0x5424b1);
};
Net.prototype.handleBlob = function(_0x5a8adb) {
    for (var _0x557648 = 0x0; _0x557648 < _0x5a8adb.length; _0x557648++) this.handlePacket(_0x5a8adb[_0x557648]);
};
Net.prototype.setState = function(_0x22651a) {
    ...
    switch (_0x22651a) {
        ...
        case 'g':
            ...
            break;
        default:
            gameClient.menu.error.show("Received invalid state ID: " + _0x22651a);
            return;
    }
    this.state.ready();
};
...
_0x5a15fa.prototype.handlePacket = function(_0x3f6cb) {
    switch (_0x3f6cb.type) {
        ...
        default:
            return gameClient.ingame() ? gameClient.game.handlePacket(_0x3f6cb) : !0x1;
    }
};
_0x5a15fa.prototype.handleBinary = function(_0x14e0f4) {
    gameClient.ingame() && gameClient.game.handleBinary(_0x14e0f4);
};
...
_0x5a15fa.prototype.load = function(_0x1c6e6f) {
    ...
    $.ajax({
        ...
        'success': function(_0x1c6e6f) {
            gameClient.load(_0x1c6e6f);
            _0x27230d.send({
                'type': "g03"
            });
        },
        'error': function() {
            gameClient.menu.error.show("Server returned FNF(404) for game file: " + _0x1c6e6f.game);
        }
    });
};
