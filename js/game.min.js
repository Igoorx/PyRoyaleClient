            ...
            if (0x0 < this.poleTimer && !this.poleWait) this.poleTimer--;
                ...
                if (!this.poleWait)
                    if (0x0 >= this.poleTimer && this.autoTarget) this.setState(PlayerObject.SNAME.STAND);
                        ...
                        for (var _0x4d4e5b = Vector2D.add(this.pos, Vector2D.make(0x0, -0.15)), _0x280236 = Vector2D.make(this.pos.x, this.pos.y - 0.15), _0x191ffc = Vector2D.make(this.dim.x, this.dim.y + 0.15), _0x280236 = this.game.world.getZone(this.level, this.zone).getTiles(_0x280236, _0x191ffc), _0x191ffc = Vector2D.make(0x1, 0x1), _0x1f539b = !0x1, _0x5a99db = 0x0; _0x5a99db < _0x280236.length; _0x5a99db++) {
...
PlayerObject.prototype.axe = function(_0x5050d5) {
    ...
    _0x5050d5 && (this.autoTarget = Vector2D.add(_0x5050d5.pos, Vector2D.make(0x0, -1.6)));
};
...
Display.prototype.drawObject = function() {
    ...
    (player = this.game.getPlayer()) && player.level === zone.level && player.zone === zone.id && (player.draw(spriteList), player.write(textList));
    var objTexture = this.resource.getTexture("obj");
    for (i = 0x0; i < spriteList.length; i++) {
        var _0x33dbbc = spriteList[i],
            _0x483d0e = Utils.sprite.getSprite(objTexture, _0x33dbbc.index),
        ...
        switch (_0x33dbbc.mode) {
            ...
            case 0x1:
                ...
                break;
            case 0x2:
                0x0 === parseInt(0.5 * this.game.frame) % 0x2 && (context.save(), _0x462c1f = !0x0, context.globalCompositeOperation = "lighter");
                break;
            case 0x3:
                _0x57dd65 = !0x0;
                break;
            default:
                0xa0 <= _0x33dbbc.mode && 0xc0 > _0x33dbbc.mode && (context.save(), _0x462c1f = !0x0, context.globalAlpha = parseFloat(_0x33dbbc.mode - 0xa0) / 0x20);
        }
        if (_0x3ce195 || _0x57dd65) context.save(), context.scale(_0x3ce195 ? -0x1 : 0x1, _0x57dd65 ? -0x1 : 0x1);
        _0x5a241d = _0x3ce195 ? -0x1 * Display.TEXRES * _0x33dbbc.pos.x - Display.TEXRES : Display.TEXRES * _0x33dbbc.pos.x;
        _0x33dbbc = _0x57dd65 ? -0x1 * Display.TEXRES * (zoneSize.y - _0x33dbbc.pos.y - 0x1) - Display.TEXRES : Display.TEXRES * (zoneSize.y - _0x33dbbc.pos.y - 0x1);
        context.drawImage(objTexture, _0x483d0e[0x0], _0x483d0e[0x1], Display.TEXRES, Display.TEXRES, _0x5a241d, _0x33dbbc, Display.TEXRES, Display.TEXRES);
        (_0x3ce195 || _0x57dd65) && context.restore();
        _0x462c1f && context.restore();
    }
    for (_0x4c6a45 = 0x0; _0x4c6a45 < textList.length; _0x4c6a45++)
        _0x31ae0d = textList[_0x4c6a45],
        _0x5a241d = Display.TEXRES * _0x31ae0d.pos.x + 0.5 * Display.TEXRES,
        _0x33dbbc = Display.TEXRES * (zoneSize.y - _0x31ae0d.pos.y - 0x1) + 0.5 * Display.TEXRES,
        context.fillStyle = _0x31ae0d.color,
        context.font = _0x31ae0d.size * Display.TEXRES + "px SmbWeb",
        context.textAlign = "center",
        context.fillText(_0x31ae0d.text, _0x5a241d, _0x33dbbc);
};
...
Display.prototype.drawUI = function() {
    ...
    0x0 < this.game.victory ? (_0x427ed3.fillStyle = "white", _0x427ed3.font = "32px SmbWeb", _0x427ed3.textAlign = "center", _0x427ed3.fillText((0x3 >= this.game.victory ? "VICTORY ROYALE #" : "TOO BAD #") + this.game.victory, 0.5 * _0x32b833, 0x28)) : (_0x427ed3.fillStyle = "white", _0x427ed3.font = "24px SmbWeb", _0x427ed3.textAlign = "left", _0x427ed3.fillText(_0x5d8ba1 ? _0x5d8ba1.name : "INFRINGIO", 0x8, 0x20), _0x52cf2c = Utils.sprite.getSprite(_0x4501e0, _0x383ae4), _0x55dbef = 'x' + (0x9 >= this.game.coins ? '0' + this.game.coins : this.game.coins), _0x427ed3.drawImage(_0x4501e0, _0x52cf2c[0x0], _0x52cf2c[0x1], Display.TEXRES, Display.TEXRES, 0x4, 0x28, 0x18, 0x18), _0x427ed3.fillText(_0x55dbef, 0x1e, 0x40), _0x52cf2c = Utils.sprite.getSprite(_0x4501e0, 0xd), _0x55dbef = _0x427ed3.measureText(_0x55dbef).width + 0x1e, _0x427ed3.drawImage(_0x4501e0, _0x52cf2c[0x0], _0x52cf2c[0x1], Display.TEXRES, Display.TEXRES, 0x4 + _0x55dbef + 0x10, 0x28, 0x18, 0x18), _0x427ed3.fillText('x' + (0x9 >= this.game.lives ? '0' + this.game.lives : this.game.lives), 0x4 + _0x55dbef + 0x10 + 0x1a, 0x40), this.game instanceof MainGame ? (_0x55dbef = this.game.remain + " PLAYERS REMAIN", _0x52cf2c = _0x427ed3.measureText(_0x55dbef).width, _0x427ed3.fillText(_0x55dbef, _0x32b833 - _0x52cf2c - 0x8, 0x20)) : this.game instanceof LobbyGame && (_0x55dbef = this.game.players.length + (this.game.touchMode ? '' : " / 25 PLAYERS"), _0x52cf2c = _0x427ed3.measureText(_0x55dbef).width, _0x427ed3.fillText(_0x55dbef, _0x32b833 - _0x52cf2c - 0x8, 0x20)), _0x52cf2c = Utils.sprite.getSprite(_0x4501e0, _0x35e95d[this.game.audio.muteMusic ? 0x1 : 0x0]), _0x427ed3.drawImage(_0x4501e0, _0x52cf2c[0x0], _0x52cf2c[0x1], Display.TEXRES, Display.TEXRES, _0x32b833 - 0x18 - 0x8, 0x28, 0x18, 0x18), _0x52cf2c = Utils.sprite.getSprite(_0x4501e0, _0x14ff97[this.game.audio.muteSound ? 0x1 : 0x0]), _0x427ed3.drawImage(_0x4501e0, _0x52cf2c[0x0], _0x52cf2c[0x1], Display.TEXRES, Display.TEXRES, _0x32b833 - 0x18 - 0x8 - 0x18 - 0x8, 0x28, 0x18, 0x18), _0x52cf2c = Utils.sprite.getSprite(_0x4501e0, _0x4580f2[this.game.disableText ? 0x1 : 0x0]), _0x427ed3.drawImage(_0x4501e0, _0x52cf2c[0x0], _0x52cf2c[0x1], Display.TEXRES, Display.TEXRES, _0x32b833 - 0x18 - 0x8 - 0x18 - 0x8 - 0x18 - 0x8, 0x28, 0x18, 0x18), this.game.input.pad.connected() && (_0x52cf2c = Utils.sprite.getSprite(_0x4501e0, 0xf8), _0x427ed3.drawImage(_0x4501e0, _0x52cf2c[0x0], _0x52cf2c[0x1], Display.TEXRES, Display.TEXRES, _0x32b833 - 0x18 - 0x8 - 0x18 - 0x8 - 0x18 - 0x8 - 0x18 - 0x8, 0x28, 0x18, 0x18)));
};
...
function MainGame(data) {
    ...
    this.display.camera.position(Vector2D.scale(_0x1d9201, 0.5));
...
MainGame.prototype.send = function(_0xeccb43) {
...
MainGame.prototype.handleBinary = function(_0x189360) {
    _0x189360 = _0x2204de.decode(_0x189360);
    this.ready ? this.updatePacket(_0x189360) : this.doUpdate(_0x189360);
};
MainGame.prototype.updatePacket = function(_0x3ed2d2) {
    for (this.buffer.push(_0x3ed2d2); this.buffer.length > MainGame.FDLC_MAX;) _0x3ed2d2 = this.buffer.shift(), this.doUpdate(_0x3ed2d2);
};
MainGame.prototype.doUpdate = function(_0x277b92) {
...
MainGame.prototype.doNET001 = function(_0xf7e5ad) {
    this.pid = _0xf7e5ad.pid;
    this.ready = !0x0;
    gameClient.menu.game.show();
};
MainGame.prototype.doNET010 = function(_0x48cbe4) {
    if (_0x48cbe4.pid !== this.pid) {
        var _0x5c28cd = this.createObject(PlayerObject.ID, _0x48cbe4.level, _0x48cbe4.zone, PackedVec2D.decode(_0x48cbe4.pos), [_0x48cbe4.pid]);
...
MainGame.prototype.doSpawn = function() {
    if (!this.getPlayer()) {
        ...
        this.createObject(PlayerObject.ID, zone.level, zone.id, PackedVec2D.decode(initial), [this.pid]);
        this.out.push(_0x591d63.encode(zone.level, zone, initial));
    }
    this.updateTeam();
};
...
LobbyGame.prototype.doNET010 = MainGame.prototype.doNET010;
