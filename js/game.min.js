...
_0x41f345.GEN_FUNC.BUMP = function(_0x3c91bc, _0x897be, _0x5d48f2, _0x43ba2c, _0x4d3e0f, _0x3ff6e1, _0x444def, _0x6654d3) {
    ...
    for (_0x444def = 0x0; _0x444def < _0x3c91bc.objects.length; _0x444def++) _0x6654d3 = _0x3c91bc.objects[_0x444def], !_0x6654d3.dead && _0x6654d3.level === _0x43ba2c && _0x6654d3.zone === _0x4d3e0f && _0x6654d3.dim && _0x1badb6.intersection(_0x3ff6e1, _0x5d48f2, _0x6654d3.pos, _0x6654d3.dim) && (_0x6654d3 instanceof _0x27b379 ? _0x6654d3.bounce() : _0x6654d3.bounce ? _0x6654d3.bounce() : _0x6654d3.bonk ? _0x6654d3.bonk() : _0x6654d3 instanceof _0x5bd111 && (_0x3c91bc.pid === _0x897be && _0x6654d3.playerCollide(_0x3c91bc.getPlayer()), _0x3c91bc.world.getZone(_0x43ba2c, _0x4d3e0f).coin(_0x6654d3.pos.x, _0x6654d3.pos.y)));
};
_0x41f345.GEN_FUNC.BREAK = function(_0x166b7e, _0x53ef4a, _0x4e42f0, _0x7eb58b, _0x3ebd05, _0x3d616e, _0x3a0031, _0x197b34) {
    ...
    for (_0x3a0031 = 0x0; _0x3a0031 < _0x166b7e.objects.length; _0x3a0031++) _0x197b34 = _0x166b7e.objects[_0x3a0031], !_0x197b34.dead && _0x197b34.level === _0x7eb58b && _0x197b34.zone === _0x3ebd05 && _0x197b34.dim && _0x1badb6.intersection(_0x3d616e, _0x4e42f0, _0x197b34.pos, _0x197b34.dim) && (_0x197b34 instanceof _0x27b379 ? _0x197b34.bounce() : _0x197b34.bounce ? _0x197b34.bounce() : _0x197b34.bonk ? _0x197b34.bonk() : _0x197b34 instanceof _0x5bd111 && (_0x166b7e.pid === _0x53ef4a && _0x197b34.playerCollide(_0x166b7e.getPlayer()), _0x166b7e.world.getZone(_0x7eb58b, _0x3ebd05).coin(_0x197b34.pos.x, _0x197b34.pos.y)));
};
...
_0x2204de.decode = function(_0x2b3586) {
    for (var _0x2fd3e2 = [], _0x2cd429 = 0x0; _0x2cd429 < _0x2b3586.length;) switch (_0x2b3586.slice(_0x2cd429++, _0x2cd429)[0x0]) {
        ...
        case 0x30:
            ...
            break;
        default:
            return _0x37bd58 && _0x37bd58.menu.warn.show("Error decoding binary data!"), _0x2fd3e2;
    }
    return _0x2fd3e2;
};
"use strict";
...
function _0xb00dea() {
    ...
    this.menus = [];
    for (var _0x554803 = 0x0; _0x554803 < _0xe00efd.length; _0x554803++) this.menus[_0x554803] = _0xe00efd[_0x554803].obj, this[_0xe00efd[_0x554803].id] = _0xe00efd[_0x554803].obj;
    this.lastNav = '';
    var _0x55f79b = this;
    window.onpopstate = function(_0xe00efd) {
        if (_0x55f79b[_0x55f79b.lastNav] && _0x55f79b[_0x55f79b.lastNav].onBack) _0x55f79b.onBack();
        else _0xe00efd.state && "Infringe Royale" !== _0xe00efd.state.pageTitle ? (document.getElementById("content").innerHTML = _0xe00efd.state.html, document.title = _0xe00efd.state.pageTitle) : _0xe00efd.state && "Infringe Royale" === _0xe00efd.state.pageTitle && window.history.back();
    };
    this.hideAll();
    this.background('c');
    this.body.style.display = "block";
}
_0xb00dea.prototype.hideAll = function() {
    for (var _0x5b448f = 0x1; _0x5b448f < this.menus.length; _0x5b448f++) this.menus[_0x5b448f].hide();
};
_0xb00dea.prototype.background = function(_0x36dd53) {
...
_0xb00dea.prototype.navigation = function(_0x440c3d, _0x2cf5df) {
...
_0xb00dea.prototype.onBack = function() {
    window.history.pushState({
        'html': "index.html",
        'pageTitle': "Infringe Royale"
    }, '', '#');
...
_0x471eac.prototype.show = function(_0x54efa4, _0x35729a, _0x56ef6b) {
    _0x37bd58.net.close();
    _0x37bd58.menu.hideAll();
    _0x37bd58.menu.navigation("error", "error");
    _0x37bd58.menu.background('b');
...
_0x47a659.prototype.show = function(_0x2c3db0) {
    _0x37bd58.menu.hideAll();
    _0x37bd58.menu.navigation("main", "main");
    _0x37bd58.menu.background('a');
...
_0x5e1c41.prototype.launch = function() {
    ...
    if (_0x37bd58.audioElement !== undefined)
        _0x37bd58.audioElement.pause();
    _0x37bd58.join(this.nameInput.value, this.teamInput.value);
};
_0x5e1c41.prototype.startPad = function() {
    var _0x3bcc0f = this,
...
_0x5e1c41.prototype.show = function() {
    _0x37bd58.menu.hideAll();
    _0x37bd58.menu.navigation("name", "name");
    _0x37bd58.menu.background('a');
    var _0x1d9f31 = Cookies.get("name"),
        _0x592523 = Cookies.get("team");
    this.nameInput.value = _0x1d9f31 ? _0x1d9f31 : '';
    this.teamInput.value = _0x592523 ? _0x592523 : '';
    this.startPad();
    this.linkElement.style.display = "block";
    this.element.style.display = "block";
};
_0x5e1c41.prototype.hide = function() {
    this.padLoop && clearTimeout(this.padLoop);
    this.linkElement.style.display = "none";
    this.element.style.display = "none";
};
_0x5e1c41.prototype.onBack = function() {
    _0x37bd58.menu.main.show();
};
"use strict";
...
_0x507387.prototype.show = function() {
    _0x37bd58.menu.hideAll();
    _0x37bd58.menu.navigation("game", "game");
    _0x37bd58.menu.background('c');
    this.element.style.display = "block";
};
...
function _0x93c9eb() {}
_0x93c9eb.prototype.connected = function() {
    return void 0x0 !== this.webSocket && this.webSocket.readyState !== WebSocket.CLOSED;
};
_0x93c9eb.prototype.connect = function(_0x3749c1, _0x175b99) {
    var _0x14cb96 = "77.68.80.27";//window.location.host;
    this.prefName = _0x3749c1;
    this.prefTeam = _0x175b99;
    var _0x3780f1 = this;
    this.connected() ? _0x37bd58.menu.error.show("Connection already open. State error.") : (this.webSocket = new WebSocket("ws://" + _0x14cb96 + "/royale/ws"), this.webSocket.binaryType = "arraybuffer", this.webSocket.onopen = function(_0x3749c1) {
        "open" !== _0x3749c1.type && _0x37bd58.menu.error.show("Error. WS open event has unexpected result.");
    }, this.webSocket.onmessage = function(_0x3749c1) {
        _0x3749c1.data instanceof ArrayBuffer ? _0x3780f1.handleBinary(new Uint8Array(_0x3749c1.data)) : _0x3780f1.handlePacket(JSON.parse(_0x3749c1.data));
    }, this.webSocket.onclose = function(_0x3749c1) {
        _0x3780f1.webSocket = void 0x0;
        _0x37bd58.menu.error.show("Connection Interrupted");
    });
};
_0x93c9eb.prototype.handlePacket = function(_0x28f70a) {
    if (void 0x0 === this.state || !this.state.handlePacket(_0x28f70a)) switch (_0x28f70a.type) {
        case "s00":
            this.setState(_0x28f70a.state);
            break;
        case "s01":
            this.handleBlob(_0x28f70a.packets);
            break;
        case "s02":
            break;
        case "x00":
            _0x37bd58.menu.error.show("Server Exception", _0x28f70a.message);
            break;
        case "x01":
            _0x37bd58.menu.error.show("Server Exception", _0x28f70a.message, _0x28f70a.trace);
            break;
        default:
            _0x37bd58.menu.error.show("Recieved invalid packet type: " + _0x28f70a.type, JSON.stringify(_0x28f70a));
    }
};
_0x93c9eb.prototype.handleBinary = function(_0x5424b1) {
    this.state.handleBinary(_0x5424b1);
};
_0x93c9eb.prototype.handleBlob = function(_0x5a8adb) {
    for (var _0x557648 = 0x0; _0x557648 < _0x5a8adb.length; _0x557648++) this.handlePacket(_0x5a8adb[_0x557648]);
};
_0x93c9eb.prototype.setState = function(_0x22651a) {
    void 0x0 !== this.state && this.state.destroy();
    switch (_0x22651a) {
        case 'l':
            this.state = new _0x5e45ff();
            break;
        case 'g':
            this.state = new _0x5a15fa();
            break;
        default:
            _0x37bd58.menu.error.show("Received invalid state ID: " + _0x22651a);
            return;
    }
    this.state.ready();
};
_0x93c9eb.prototype.send = function(_0x2756bb) {
    this.webSocket.send(JSON.stringify(_0x2756bb));
};
_0x93c9eb.prototype.sendBinary = function(_0x25450f) {
    this.webSocket.send(_0x25450f.buffer);
};
_0x93c9eb.prototype.close = function() {
    void 0x0 !== this.webSocket && this.webSocket.close();
    _0x37bd58.ingame() && _0x37bd58.game.destroy();
};
"use strict";

function _0x5e45ff() {}
_0x5e45ff.prototype.handlePacket = function(_0x47468f) {
...
_0x5e45ff.prototype.handleBinary = function(_0x6d4bf6) {
    _0x37bd58.menu.warn.show("Recieved unexpected binary data!");
};
_0x5e45ff.prototype.ready = function() {
    this.send({
        'type': "l00",
        'name': _0x37bd58.net.prefName,
        'team': _0x37bd58.net.prefTeam
    });
};
_0x5e45ff.prototype.loggedIn = function(_0x2678ae) {
    _0x37bd58.net.name = _0x2678ae.name;
    _0x37bd58.net.sid = _0x2678ae.sid;
    console.log("Logged in: " + _0x2678ae.name + " :: " + _0x2678ae.team + " // " + _0x2678ae.sid);
};
_0x5e45ff.prototype.send = function(_0x21f464) {
    _0x37bd58.net.send(_0x21f464);
};
_0x5e45ff.prototype.type = function() {
    return 'l';
};
_0x5e45ff.prototype.destroy = function() {};
"use strict";
...
_0x5a15fa.prototype.handlePacket = function(_0x3f6cb) {
    switch (_0x3f6cb.type) {
        case "g01":
            return this.load(_0x3f6cb), !0x0;
        case "g06":
            return this.globalWarn(_0x3f6cb), !0x0;
        case "g21":
            return this.recievePing(_0x3f6cb), !0x0;
        default:
            return _0x37bd58.ingame() ? _0x37bd58.game.handlePacket(_0x3f6cb) : !0x1;
    }
};
_0x5a15fa.prototype.handleBinary = function(_0x14e0f4) {
    _0x37bd58.ingame() && _0x37bd58.game.handleBinary(_0x14e0f4);
};
_0x5a15fa.prototype.ready = function() {
    this.send({
        'type': "g00"
    });
};
_0x5a15fa.prototype.load = function(_0x1c6e6f) {
    var _0x27230d = this;
    $.ajax({
        'url': "http://" + window.location.host + "/royale/game/" + _0x1c6e6f.game,
        'type': "GET",
        'timeout': 0x1388,
        'success': function(_0x1c6e6f) {
            _0x37bd58.load(_0x1c6e6f);
            _0x27230d.send({
                'type': "g03"
            });
        },
        'error': function() {
            _0x37bd58.menu.error.show("Server returned FNF(404) for game file: " + _0x1c6e6f.game);
        }
    });
};
_0x5a15fa.prototype.globalWarn = function(_0xba301c) {
    _0x37bd58.menu.warn.show(_0xba301c.message);
};
_0x5a15fa.prototype.sendPing = function() {
    var _0x1ac5e9 = _0x33a76c.time.now();
    this.pingOut && 0x3e7 > this.pingLast - _0x1ac5e9 || (this.pingOut && (_0x37bd58.net.ping = 0x3e7), this.send({
        'type': "g21",
        'delta': _0x1ac5e9
    }), this.pingOut = !0x0);
};
_0x5a15fa.prototype.recievePing = function(_0x5bdfa8) {
    var _0x3162e8 = _0x33a76c.time.now();
    _0x37bd58.net.ping = _0x3162e8 - _0x5bdfa8.delta;
    this.pingOut = !0x1;
};
_0x5a15fa.prototype.send = function(_0x32a3b0) {
    _0x37bd58.net.send(_0x32a3b0);
};
_0x5a15fa.prototype.type = function() {
    return 'g';
};
_0x5a15fa.prototype.destroy = function() {};
"use strict";
...
_0x3da6cc.OBJECT = function(_0x42193c) {
    ...
    _0x37bd58.menu.warn.show("Invalid Object Class ID: " + _0x42193c);
};
"use strict";

function _0x27b379(_0x2bc274, _0x3817eb, _0x2345aa, _0x4df2ca, _0x3b448f) {
    ...
    this.attackCharge = _0x27b379.MAX_CHARGE;
    this.attackTimer = 0x0;
    this.autoTarget = void 0x0;
    this.btnD = [0x0, 0x0];
    this.btnBde = this.btnBg = this.btnB = this.btnA = !0x1;
    this.setState(_0x27b379.SNAME.STAND);
}
_0x27b379.ASYNC = !0x1;
_0x27b379.ID = 0x1;
_0x27b379.NAME = "PLAYER";
_0x27b379.ANIMATION_RATE = 0x3;
_0x27b379.DIM_OFFSET = _0x26de58.make(-0.05, 0x0);
_0x27b379.DEAD_FREEZE_TIME = 0x7;
_0x27b379.DEAD_TIME = 0x46;
_0x27b379.DEAD_UP_FORCE = 0.65;
_0x27b379.RUN_SPEED_MAX = 0.315;
_0x27b379.MOVE_SPEED_MAX = 0.215;
_0x27b379.MOVE_SPEED_ACCEL = 0.0125;
_0x27b379.MOVE_SPEED_DECEL = 0.0225;
_0x27b379.MOVE_SPEED_ACCEL_AIR = 0.0025;
_0x27b379.STUCK_SLIDE_SPEED = 0.08;
_0x27b379.FALL_SPEED_MAX = 0.45;
_0x27b379.FALL_SPEED_ACCEL = 0.085;
_0x27b379.BOUNCE_LENGTH_MIN = 0x1;
_0x27b379.SPRING_LENGTH_MIN = 0x5;
_0x27b379.SPRING_LENGTH_MAX = 0xe;
_0x27b379.JUMP_LENGTH_MIN = 0x3;
_0x27b379.JUMP_LENGTH_MAX = 0x7;
_0x27b379.JUMP_SPEED_INC_THRESHOLD = [0.1, 0.2, 0.25];
_0x27b379.JUMP_DECEL = 0.005;
_0x27b379.BLOCK_BUMP_THRESHOLD = 0.12;
_0x27b379.POWER_INDEX_SIZE = 0x20;
_0x27b379.GENERIC_INDEX = 0x60;
_0x27b379.DAMAGE_TIME = 0x2d;
_0x27b379.TRANSFORM_TIME = 0x12;
_0x27b379.TRANSFORM_ANIMATION_RATE = 0x2;
_0x27b379.STAR_LENGTH = 0x168;
_0x27b379.PROJ_OFFSET = _0x26de58.make(0.7, 1.1);
_0x27b379.MAX_CHARGE = 0x3c;
_0x27b379.ATTACK_DELAY = 0x7;
_0x27b379.ATTACK_CHARGE = 0x19;
_0x27b379.ATTACK_ANIM_LENGTH = 0x3;
_0x27b379.PIPE_TIME = 0x1e;
_0x27b379.PIPE_SPEED = 0.06;
_0x27b379.PIPE_EXT_OFFSET = _0x26de58.make(0.5, 0x0);
_0x27b379.WEED_EAT_RADIUS = 0x3;
_0x27b379.POLE_DELAY = 0xf;
_0x27b379.POLE_SLIDE_SPEED = 0.15;
_0x27b379.LEVEL_END_MOVE_OFF = _0x26de58.make(0xa, 0x0);
_0x27b379.CLIMB_SPEED = 0.125;
_0x27b379.PLATFORM_SNAP_DIST = 0.15;
_0x27b379.ARROW_SPRITE = 0xfd;
_0x27b379.ARROW_TEXT = "YOU";
_0x27b379.ARROW_OFFSET = _0x26de58.make(0x0, 0.1);
_0x27b379.TEXT_OFFSET = _0x26de58.make(0x0, 0.55);
_0x27b379.TEXT_SIZE = 0.65;
_0x27b379.TEXT_COLOR = "#FFFFFF";
_0x27b379.ARROW_RAD_IN = 0x3;
_0x27b379.ARROW_RAD_OUT = 0x7;
_0x27b379.ARROW_THRESHOLD_MIN = 0x4;
_0x27b379.ARROW_THRESHOLD_MAX = 0x6;
_0x27b379.TEAM_OFFSET = _0x26de58.make(0x0, 0x0);
_0x27b379.TEAM_SIZE = 0.3;
_0x27b379.TEAM_COLOR = "rgba(255,255,255,0.75)";
_0x27b379.SPRITE = {};
_0x27b379.SPRITE_LIST = [{
    'NAME': "S_STAND",
    'ID': 0x0,
    'INDEX': 0xd
}, {
...
for (var _0x1bec55 = 0x0; _0x1bec55 < _0x27b379.SPRITE_LIST.length; _0x1bec55++) _0x27b379.SPRITE[_0x27b379.SPRITE_LIST[_0x1bec55].NAME] = _0x27b379.SPRITE_LIST[_0x1bec55], _0x27b379.SPRITE[_0x27b379.SPRITE_LIST[_0x1bec55].ID] = _0x27b379.SPRITE_LIST[_0x1bec55];
_0x27b379.SNAME = {};
_0x27b379.SNAME.STAND = "STAND";
_0x27b379.SNAME.DOWN = "DOWN";
_0x27b379.SNAME.RUN = "RUN";
_0x27b379.SNAME.SLIDE = "SLIDE";
_0x27b379.SNAME.FALL = "FALL";
_0x27b379.SNAME.POLE = "POLE";
_0x27b379.SNAME.CLIMB = "CLIMB";
_0x27b379.SNAME.ATTACK = "ATTACK";
_0x27b379.SNAME.TRANSFORM = "TRANSFORM";
_0x27b379.SNAME.DEAD = "DEAD";
_0x27b379.SNAME.HIDE = "HIDE";
_0x27b379.SNAME.GHOST = "GHOST";
_0x27b379.SNAME.DEADGHOST = "DEADGHOST";
var _0x4a74c1 = _0x26de58.make(0.9, 0.95),
    _0x124f5a = _0x26de58.make(0.9, 1.9);
_0x27b379.STATE = [{
    'NAME': _0x27b379.SNAME.STAND,
    'ID': 0x0,
    'DIM': _0x4a74c1,
    'SPRITE': [_0x27b379.SPRITE.S_STAND]
}, {
    'NAME': _0x27b379.SNAME.DOWN,
    'ID': 0x1,
    'DIM': _0x4a74c1,
    'SPRITE': [_0x27b379.SPRITE.S_STAND]
}, {
    'NAME': _0x27b379.SNAME.RUN,
    'ID': 0x2,
    'DIM': _0x4a74c1,
    'SPRITE': [_0x27b379.SPRITE.S_RUN2, _0x27b379.SPRITE.S_RUN1, _0x27b379.SPRITE.S_RUN0]
}, {
    'NAME': _0x27b379.SNAME.SLIDE,
    'ID': 0x3,
    'DIM': _0x4a74c1,
    'SPRITE': [_0x27b379.SPRITE.S_SLIDE]
}, {
    'NAME': _0x27b379.SNAME.FALL,
    'ID': 0x4,
    'DIM': _0x4a74c1,
    'SPRITE': [_0x27b379.SPRITE.S_FALL]
}, {
    'NAME': _0x27b379.SNAME.TRANSFORM,
    'ID': 0x5,
    'DIM': _0x4a74c1,
    'SPRITE': [_0x27b379.SPRITE.S_STAND]
}, {
    'NAME': _0x27b379.SNAME.POLE,
    'ID': 0x6,
    'DIM': _0x4a74c1,
    'SPRITE': [_0x27b379.SPRITE.S_CLIMB1]
}, {
    'NAME': _0x27b379.SNAME.CLIMB,
    'ID': 0x7,
    'DIM': _0x4a74c1,
    'SPRITE': [_0x27b379.SPRITE.S_CLIMB0, _0x27b379.SPRITE.S_CLIMB1]
}, {
    'NAME': _0x27b379.SNAME.STAND,
    'ID': 0x20,
    'DIM': _0x124f5a,
    'SPRITE': [_0x27b379.SPRITE.B_STAND]
}, {
    'NAME': _0x27b379.SNAME.DOWN,
    'ID': 0x21,
    'DIM': _0x4a74c1,
    'SPRITE': [_0x27b379.SPRITE.B_DOWN]
}, {
    'NAME': _0x27b379.SNAME.RUN,
    'ID': 0x22,
    'DIM': _0x124f5a,
    'SPRITE': [_0x27b379.SPRITE.B_RUN2, _0x27b379.SPRITE.B_RUN1, _0x27b379.SPRITE.B_RUN0]
}, {
    'NAME': _0x27b379.SNAME.SLIDE,
    'ID': 0x23,
    'DIM': _0x124f5a,
    'SPRITE': [_0x27b379.SPRITE.B_SLIDE]
}, {
    'NAME': _0x27b379.SNAME.FALL,
    'ID': 0x24,
    'DIM': _0x124f5a,
    'SPRITE': [_0x27b379.SPRITE.B_FALL]
}, {
    'NAME': _0x27b379.SNAME.TRANSFORM,
    'ID': 0x25,
    'DIM': _0x4a74c1,
    'SPRITE': [_0x27b379.SPRITE.B_TRANSFORM]
}, {
    'NAME': _0x27b379.SNAME.POLE,
    'ID': 0x26,
    'DIM': _0x124f5a,
    'SPRITE': [_0x27b379.SPRITE.B_CLIMB0]
}, {
    'NAME': _0x27b379.SNAME.CLIMB,
    'ID': 0x27,
    'DIM': _0x124f5a,
    'SPRITE': [_0x27b379.SPRITE.B_CLIMB0, _0x27b379.SPRITE.B_CLIMB1]
}, {
    'NAME': _0x27b379.SNAME.STAND,
    'ID': 0x40,
    'DIM': _0x124f5a,
    'SPRITE': [_0x27b379.SPRITE.F_STAND]
}, {
    'NAME': _0x27b379.SNAME.DOWN,
    'ID': 0x41,
    'DIM': _0x4a74c1,
    'SPRITE': [_0x27b379.SPRITE.F_DOWN]
}, {
    'NAME': _0x27b379.SNAME.RUN,
    'ID': 0x42,
    'DIM': _0x124f5a,
    'SPRITE': [_0x27b379.SPRITE.F_RUN2, _0x27b379.SPRITE.F_RUN1, _0x27b379.SPRITE.F_RUN0]
}, {
    'NAME': _0x27b379.SNAME.SLIDE,
    'ID': 0x43,
    'DIM': _0x124f5a,
    'SPRITE': [_0x27b379.SPRITE.F_SLIDE]
}, {
    'NAME': _0x27b379.SNAME.FALL,
    'ID': 0x44,
    'DIM': _0x124f5a,
    'SPRITE': [_0x27b379.SPRITE.F_FALL]
}, {
    'NAME': _0x27b379.SNAME.ATTACK,
    'ID': 0x45,
    'DIM': _0x124f5a,
    'SPRITE': [_0x27b379.SPRITE.F_ATTACK]
}, {
    'NAME': _0x27b379.SNAME.TRANSFORM,
    'ID': 0x46,
    'DIM': _0x4a74c1,
    'SPRITE': [_0x27b379.SPRITE.F_TRANSFORM]
}, {
    'NAME': _0x27b379.SNAME.POLE,
    'ID': 0x47,
    'DIM': _0x124f5a,
    'SPRITE': [_0x27b379.SPRITE.F_CLIMB0]
}, {
    'NAME': _0x27b379.SNAME.CLIMB,
    'ID': 0x48,
    'DIM': _0x124f5a,
    'SPRITE': [_0x27b379.SPRITE.F_CLIMB0, _0x27b379.SPRITE.F_CLIMB1]
}, {
    'NAME': _0x27b379.SNAME.DEAD,
    'DIM': _0x4a74c1,
    'ID': 0x60,
    'SPRITE': [_0x27b379.SPRITE.G_DEAD]
}, {
    'NAME': _0x27b379.SNAME.HIDE,
    'DIM': _0x4a74c1,
    'ID': 0x70,
    'SPRITE': [_0x27b379.SPRITE.G_HIDE]
}, {
    'NAME': _0x27b379.SNAME.GHOST,
    'DIM': _0x4a74c1,
    'ID': 0xff,
    'SPRITE': []
}, {
    'NAME': _0x27b379.SNAME.DEADGHOST,
    'DIM': _0x4a74c1,
    'ID': 0xfe,
    'SPRITE': [_0x27b379.SPRITE.G_DEAD]
}];
_0x27b379.prototype.update = function(_0x60d16c) {
    this.dead || this.garbage || (this.setState(_0x27b379.SNAME.GHOST), this.level = _0x60d16c.level, this.zone = _0x60d16c.zone, this.pos = _0x60d16c.pos, this.sprite = _0x27b379.SPRITE[_0x60d16c.sprite], this.reverse = _0x60d16c.reverse);
};
_0x27b379.prototype.trigger = function(_0x121f75) {
    switch (_0x121f75) {
        case 0x1:
            this.attack();
            break;
...
_0x27b379.prototype.step = function() {
    0x0 < this.starTimer ? this.starTimer-- : this.starMusic && (this.starMusic.stop(), this.starMusic = void 0x0);
    if (this.isState(_0x27b379.SNAME.GHOST)) this.sound();
    else if (!this.isState(_0x27b379.SNAME.HIDE))
        if (this.isState(_0x27b379.SNAME.POLE))
            if (0x0 < this.poleTimer && !this.poleWait) this.poleTimer--;
            else {
                this.poleSound || (this.poleSound = !0x0, this.play("sfx/flagpole.wav", 0x1, 0x0));
                if (!this.poleWait)
                    if (0x0 >= this.poleTimer && this.autoTarget) this.setState(_0x27b379.SNAME.STAND);
                    else {
                        ...
                        _0x1f539b ? (this.poleTimer = 0xf, this.autoTarget = _0x26de58.add(_0x4d4e5b, _0x27b379.LEVEL_END_MOVE_OFF), this.poleWait = !0x0) : this.pos = _0x4d4e5b;
    ...
    else if (this.isState(_0x27b379.SNAME.RUN) ? this.anim += Math.max(0.5, Math.abs(0x5 * this.moveSpeed)) : this.anim++, this.sprite = this.state.SPRITE[parseInt(parseInt(this.anim) / _0x27b379.ANIMATION_RATE) % this.state.SPRITE.length], this.isState(_0x27b379.SNAME.CLIMB)) this.pos.y += _0x27b379.CLIMB_SPEED, this.pos.y >= this.game.world.getZone(this.level, this.zone).dimensions().y && (this.warp(this.vineWarp), this.setState(_0x27b379.SNAME.FALL));
    else if (this.isState(_0x27b379.SNAME.DEAD) || this.isState(_0x27b379.SNAME.DEADGHOST)) 0x0 < this.deadFreezeTimer ? this.deadFreezeTimer-- : 0x0 < this.deadTimer ? (this.deadTimer--, this.pos.y += this.fallSpeed, this.fallSpeed = Math.max(this.fallSpeed - 0.085, -0.45)) : this.destroy();
    else if (this.isState(_0x27b379.SNAME.TRANSFORM))
        if (0x0 < --this.tfmTimer) switch (_0x4d4e5b = parseInt(this.anim / _0x27b379.TRANSFORM_ANIMATION_RATE) % 0x3, _0x280236 = this.power > this.tfmTarget ? this.power : this.tfmTarget, _0x4d4e5b) {
            case 0x0:
                this.sprite = this.getStateByPowerIndex(_0x27b379.SNAME.STAND, this.power).SPRITE[0x0];
                break;
            case 0x1:
                this.sprite = this.getStateByPowerIndex(_0x27b379.SNAME.TRANSFORM, _0x280236).SPRITE[0x0];
                break;
            case 0x2:
                this.sprite = this.getStateByPowerIndex(_0x27b379.SNAME.STAND, this.tfmTarget).SPRITE[0x0];
        } else this.power = this.tfmTarget, this.tfmTarget = -0x1, this.setState(_0x27b379.SNAME.STAND), this.collisionTest(this.pos, this.dim) && this.setState(_0x27b379.SNAME.DOWN), this.damageTimer = _0x27b379.DAMAGE_TIME;
        ...
        if (0x0 >= this.pipeTimer && this.pipeWarp) {
            ...
            switch (this.pipeExt) {
                case 0x1:
                    this.pos.y -= 1.74;
                    this.setState(_0x27b379.SNAME.STAND);
                    this.pos = _0x26de58.add(this.pos, _0x27b379.PIPE_EXT_OFFSET);
                    break;
                case 0x2:
                    this.pos.y += 1.74;
                    this.setState(_0x27b379.SNAME.STAND);
                ...
                case 0x3:
                    this.pos.x -= 1.74;
                    this.setState(_0x27b379.SNAME.RUN);
                    break;
                case 0x4:
                    this.pos.x += 1.74;
                    this.setState(_0x27b379.SNAME.RUN);
    ...
    } else this.lastPos = this.pos, 0x0 < this.damageTimer && this.damageTimer--, this.attackCharge < _0x27b379.MAX_CHARGE && this.attackCharge++, 0x0 < this.attackTimer && this.attackTimer--, this.autoTarget && this.autoMove(), this.control(), this.physics(), this.interaction(), this.arrow(), this.sound(), 0x0 > this.pos.y && this.kill();
};
_0x27b379.prototype.input = function(_0x17fbef, _0x49fbc5, _0xb14c91) {
    this.btnD = _0x17fbef;
    this.btnA = _0x49fbc5;
    this.btnB = _0xb14c91;
};
_0x27b379.prototype.autoMove = function() {
    this.btnD = [0x0, 0x0];
...
_0x27b379.prototype.control = function() {
    this.grounded && (this.btnBg = this.btnB);
    if (this.isState(_0x27b379.SNAME.DOWN) && this.collisionTest(this.pos, this.getStateByPowerIndex(_0x27b379.SNAME.STAND, this.power).DIM)) - 0x1 !== this.btnD[0x1] && (this.moveSpeed = 0.5 * (this.moveSpeed + _0x27b379.STUCK_SLIDE_SPEED)), this.moveSpeed = Math.sign(this.moveSpeed) * Math.max(Math.abs(this.moveSpeed) - _0x27b379.MOVE_SPEED_DECEL, 0x0);
    else {
        0x0 !== this.btnD[0x0] ? (0.01 < Math.abs(this.moveSpeed) && !(0x0 <= this.btnD[0x0] ^ 0x0 > this.moveSpeed) ? (this.moveSpeed += _0x27b379.MOVE_SPEED_DECEL * this.btnD[0x0], this.setState(_0x27b379.SNAME.SLIDE)) : (this.moveSpeed = this.btnD[0x0] * Math.min(Math.abs(this.moveSpeed) + 0.0125, this.btnBg ? 0.315 : 0.215), this.setState(_0x27b379.SNAME.RUN)), this.grounded && (this.reverse = 0x0 <= this.btnD[0x0])) : (0.01 < Math.abs(this.moveSpeed) ? (this.moveSpeed = Math.sign(this.moveSpeed) * Math.max(Math.abs(this.moveSpeed) - _0x27b379.MOVE_SPEED_DECEL, 0x0), this.setState(_0x27b379.SNAME.RUN)) : (this.moveSpeed = 0x0, this.setState(_0x27b379.SNAME.STAND)), -0x1 === this.btnD[0x1] && this.setState(_0x27b379.SNAME.DOWN));
        for (var _0x41484b = this.isSpring ? 0xe : 0x7, _0x39fd87 = this.isSpring ? _0x27b379.SPRING_LENGTH_MIN : this.isBounce ? _0x27b379.BOUNCE_LENGTH_MIN : _0x27b379.JUMP_LENGTH_MIN, _0x4f2d3c = 0x0; _0x4f2d3c < _0x27b379.JUMP_SPEED_INC_THRESHOLD.length && Math.abs(this.moveSpeed) >= _0x27b379.JUMP_SPEED_INC_THRESHOLD[_0x4f2d3c]; _0x4f2d3c++) _0x41484b++;
        ...
        this.grounded || this.setState(_0x27b379.SNAME.FALL);
        this.btnB && !this.btnBde && 0x2 === this.power && !this.isState(_0x27b379.SNAME.DOWN) && !this.isState(_0x27b379.SNAME.SLIDE) && 0x1 > this.attackTimer && this.attackCharge >= _0x27b379.ATTACK_CHARGE && (this.attack(), this.game.out.push(_0x2ca693.encode(0x1)));
        this.btnBde = this.btnB;
        0x0 < this.attackTimer && 0x2 === this.power && (this.isState(_0x27b379.SNAME.STAND) || this.isState(_0x27b379.SNAME.RUN)) && this.setState(_0x27b379.SNAME.ATTACK);
    }
};
_0x27b379.prototype.physics = function() {
    ...
    for (_0x5b32b0 = 0x0; _0x5b32b0 < _0x27521c.length; _0x5b32b0++) _0x28e288 = _0x27521c[_0x5b32b0], _0x1badb6.intersection(_0x28e288.pos, _0x208a75, _0x57b791, this.dim) && (this.fallSpeed > _0x27b379.BLOCK_BUMP_THRESHOLD && _0x50b7b9.push(_0x28e288), 0x0 > this.fallSpeed && this.pos.y >= _0x28e288.pos.y && _0x27c16e.push(_0x28e288));
    ...
    for (_0x5b32b0 = 0x0; _0x5b32b0 < _0x535e81.length; _0x5b32b0++)
        if (_0x28e288 = _0x535e81[_0x5b32b0], this.pos.y >= _0x57b791.y && _0x28e288.pos.y + _0x28e288.dim.y - this.pos.y < _0x27b379.PLATFORM_SNAP_DIST) {
    ...
    if (this.isState(_0x27b379.SNAME.DOWN) && 0.05 > this.moveSpeed)
    ...
    if (this.isState(_0x27b379.SNAME.RUN))
...
_0x27b379.prototype.arrow = function() {
    for (var _0x37a11c = 0x0, _0x389b03 = 0x0; _0x389b03 < this.game.objects.length; _0x389b03++) {
        ...
        _0x2c4088 !== this && _0x2c4088 instanceof _0x27b379 && _0x2c4088.level === this.level && _0x2c4088.zone === this.zone && (_0x37a11c += 0x1 - Math.min(_0x27b379.ARROW_RAD_OUT, Math.max(0x0, _0x26de58.distance(this.pos, _0x2c4088.pos) - _0x27b379.ARROW_RAD_IN)) / _0x27b379.ARROW_RAD_OUT);
    }
    this.arrowFade = Math.min(_0x27b379.ARROW_THRESHOLD_MAX, Math.max(0x0, _0x37a11c - _0x27b379.ARROW_THRESHOLD_MIN)) / _0x27b379.ARROW_THRESHOLD_MAX;
};
_0x27b379.prototype.sound = _0x3da6cc.prototype.sound;
_0x27b379.prototype.attack = function() {
    this.attackTimer = _0x27b379.ATTACK_DELAY;
    this.attackCharge -= _0x27b379.ATTACK_CHARGE;
    var _0x328458 = this.reverse ? _0x26de58.add(this.pos, _0x27b379.PROJ_OFFSET) : _0x26de58.add(this.pos, _0x26de58.multiply(_0x27b379.PROJ_OFFSET, _0x26de58.make(-0x1, 0x1)));
...
_0x27b379.prototype.bounce = function() {
    this.jumping = 0x0;
    this.isBounce = !0x0;
};
_0x27b379.prototype.damage = function(_0x782da0) {
    0x0 < this.damageTimer || 0x0 < this.starTimer || this.isState(_0x27b379.SNAME.TRANSFORM) || this.isState(_0x27b379.SNAME.CLIMB) || this.isState(_0x27b379.SNAME.POLE) || this.pipeWarp || 0x0 < this.pipeTimer || 0x0 < this.pipeDelay || this.autoTarget || (0x0 < this.power ? (this.tfm(0x0), this.damageTimer = _0x27b379.DAMAGE_TIME) : this.kill());
};
_0x27b379.prototype.invuln = function() {
    this.damageTimer = _0x27b379.DAMAGE_TIME;
};
_0x27b379.prototype.powerup = function(_0x316532) {
    _0x316532 instanceof _0x2a84ef && 0x1 > this.power ? (this.tfm(0x1), this.rate = 0x73) : _0x316532 instanceof _0x42d5d2 && 0x2 > this.power ? (this.tfm(0x2), this.rate = 0x71) : _0x316532 instanceof _0x328b6a ? (this.star(), this.game.out.push(_0x2ca693.encode(0x2)), this.rate = 0x43) : _0x316532 instanceof _0x515a84 ? this.game.lifeage() : _0x316532 instanceof _0x5bd111 ? this.game.coinage() : _0x316532 instanceof _0x2aba82 ? this.game.out.push(_0x2656cf.encode()) : _0x316532 instanceof _0x5010c8 && this.damage(_0x316532);
};
_0x27b379.prototype.axe = function(_0x5050d5) {
...
_0x27b379.prototype.pipe = function(_0x157842, _0x266382, _0x3f3ba4) {
    0x1 !== _0x157842 && 0x2 !== _0x157842 || this.setState(_0x27b379.SNAME.STAND);
...
_0x27b379.prototype.weedeat = function() {
    for (var _0x5cc521 = 0x0; _0x5cc521 < this.game.objects.length; _0x5cc521++) {
        var _0x526625 = this.game.objects[_0x5cc521];
        _0x526625 instanceof _0xa70071 && !_0x526625.dead && _0x26de58.distance(this.pos, _0x526625.pos) < _0x27b379.WEED_EAT_RADIUS && _0x526625.destroy();
    }
};
_0x27b379.prototype.pole = function(_0x4a8021) {
    this.autoTarget || (this.setState(_0x27b379.SNAME.POLE), this.fallSpeed = this.moveSpeed = 0x0, this.pos.x = _0x4a8021.x, this.poleTimer = 0xf, this.poleSound = !0x1);
};
_0x27b379.prototype.vine = function(_0x4cfee8, _0x16f983) {
    this.setState(_0x27b379.SNAME.CLIMB);
    this.fallSpeed = this.moveSpeed = 0x0;
    this.pos.x = _0x4cfee8.x;
    this.vineWarp = _0x16f983;
};
_0x27b379.prototype.hide = function() {
    this.setState(_0x27b379.SNAME.HIDE);
};
_0x27b379.prototype.show = function() {
    this.setState(_0x27b379.SNAME.STAND);
};
_0x27b379.prototype.kill = function() {
    this.starMusic && (this.starMusic.stop(), this.starMusic = void 0x0, this.starTimer = 0x0);
    this.isState(_0x27b379.SNAME.GHOST) ? this.setState(_0x27b379.SNAME.DEADGHOST) : this.setState(_0x27b379.SNAME.DEAD);
    this.dead = !0x0;
    this.deadTimer = _0x27b379.DEAD_TIME;
    this.deadFreezeTimer = _0x27b379.DEAD_FREEZE_TIME;
    this.fallSpeed = _0x27b379.DEAD_UP_FORCE;
    if (this.game.getPlayer() === this) {
        this.game.out.push(_0x4c5df7.encode());
        var _0x27d445 = Cookies.get("sad_gamer_moments");
    Cookies.set("sad_gamer_moments", _0x27d445 ? parseInt(_0x27d445) + 0x1 : 0x1, {
        'expires': 0x16d
    });
    }
};
_0x27b379.prototype.destroy = function() {
    this.starMusic && (this.starMusic.stop(), this.starMusic = void 0x0, this.starTimer = 0x0);
    _0x3da6cc.prototype.destroy.call(this);
};
_0x27b379.prototype.isTangible = function() {
    return _0x3da6cc.prototype.isTangible.call(this) && !this.isState(_0x27b379.SNAME.HIDE) && 0x0 >= this.pipeDelay;
};
_0x27b379.prototype.setState = function(_0x50b226) {
...
_0x27b379.prototype.getStateByPowerIndex = function(_0x40e9b8, _0x2a26f5) {
    for (var _0x445ce9 = 0x0; _0x445ce9 < _0x27b379.STATE.length; _0x445ce9++) {
        var _0x44768c = _0x27b379.STATE[_0x445ce9];
        if (_0x44768c.NAME === _0x40e9b8 && (_0x44768c.ID >= _0x27b379.GENERIC_INDEX || _0x44768c.ID >= _0x27b379.POWER_INDEX_SIZE * _0x2a26f5 && _0x44768c.ID < _0x27b379.POWER_INDEX_SIZE * (_0x2a26f5 + 0x1))) return _0x44768c;
    }
};
_0x27b379.prototype.isState = function(_0x5b2890) {
    return _0x5b2890 === this.state.NAME;
};
_0x27b379.prototype.draw = function(_0x45dd8c) {
    if (!(this.isState(_0x27b379.SNAME.HIDE) || 0x0 < this.pipeDelay || 0x0 < this.damageTimer && 0x1 < this.damageTimer % 0x3)) {
        var _0x5c9425;
        _0x5c9425 = 0x0 < this.starTimer ? 0x2 : this.isState(_0x27b379.SNAME.GHOST) || this.isState(_0x27b379.SNAME.DEADGHOST) ? 0x1 : 0x0;
        if (this.sprite.INDEX instanceof Array)
            for (var _0x5814e0 = this.sprite.INDEX, _0x3f6b38 = 0x0; _0x3f6b38 < _0x5814e0.length; _0x3f6b38++)
                for (var _0x13a17a = 0x0; _0x13a17a < _0x5814e0[_0x3f6b38].length; _0x13a17a++) 0x2 === _0x5c9425 && _0x45dd8c.push({
                    'pos': _0x26de58.add(_0x26de58.add(this.pos, _0x27b379.DIM_OFFSET), _0x26de58.make(this.reverse ? _0x13a17a : -_0x13a17a, _0x3f6b38)),
            ...
            'pos': _0x26de58.add(this.pos, _0x27b379.DIM_OFFSET),
            'reverse': this.reverse,
        ...
        0x0 < this.arrowFade && (_0x5c9425 = 0xa0 + parseInt(0x20 * this.arrowFade), _0x45dd8c.push({
            'pos': _0x26de58.add(_0x26de58.add(this.pos, _0x26de58.make(0x0, this.dim.y)), _0x27b379.ARROW_OFFSET),
            'reverse': !0x1,
            'index': _0x27b379.ARROW_SPRITE,
            'mode': _0x5c9425
        }));
    }
};
_0x27b379.prototype.write = function(_0x239cf4) {
    0x0 < this.arrowFade ? _0x239cf4.push({
        'pos': _0x26de58.add(_0x26de58.add(this.pos, _0x26de58.make(0x0, this.dim.y)), _0x27b379.TEXT_OFFSET),
        'size': _0x27b379.TEXT_SIZE,
        'color': "rgba(255,255,255," + this.arrowFade + ')',
        'text': _0x27b379.ARROW_TEXT
    }) : this.name && _0x239cf4.push({
        'pos': _0x26de58.add(_0x26de58.add(this.pos, _0x26de58.make(0x0, this.sprite.INDEX instanceof Array ? 0x2 : 0x1)), _0x27b379.TEAM_OFFSET),
        'size': _0x27b379.TEAM_SIZE,
        'color': _0x27b379.TEAM_COLOR,
        'text': this.name
    });
};
_0x27b379.prototype.play = _0x3da6cc.prototype.play;
_0x3da6cc.REGISTER_OBJECT(_0x27b379);
"use strict";
...
_0xafe583.prototype.interaction = function() {
    if (this.state === _0xafe583.STATE.SPIN)
        for (var _0x369f51 = 0x0; _0x369f51 < this.game.objects.length; _0x369f51++) {
            ...
            _0x597333 === this || _0x597333 instanceof _0x27b379 || !_0x597333.isTangible() || !_0x597333.damage || _0x597333.level === this.level && _0x597333.zone === this.zone && _0x1badb6.intersection(_0x597333.pos, _0x597333.dim, this.pos, this.dim) && _0x597333.damage(this);
        }
};
...
_0x5e412e.prototype.interaction = function() {
    if (this.state === _0x5e412e.STATE.SPIN)
        for (var _0x55c0e3 = 0x0; _0x55c0e3 < this.game.objects.length; _0x55c0e3++) {
            ...
            _0xa2c7b4 === this || _0xa2c7b4 instanceof _0x27b379 || !_0xa2c7b4.isTangible() || !_0xa2c7b4.damage || _0xa2c7b4.level === this.level && _0xa2c7b4.zone === this.zone && _0x1badb6.intersection(_0xa2c7b4.pos, _0xa2c7b4.dim, this.pos, this.dim) && _0xa2c7b4.damage();
        }
};
...
_0x1f4abb.prototype.face = function() {
    for (var _0xe75dbb, _0x338971 = 0x0; _0x338971 < this.game.objects.length; _0x338971++) {
        ...
        _0x345c5d instanceof _0x27b379 && _0x345c5d.level === this.level && _0x345c5d.zone === this.zone && _0x345c5d.isTangible() && (!_0xe75dbb || Math.abs(_0xe75dbb) > _0x26de58.distance(_0x345c5d.pos, this.pos)) && (_0xe75dbb = _0x345c5d.pos.x - this.pos.x);
    }
...
function _0x36be10(_0x296e51, _0xaf6db9, _0x35a12d, _0x5dd1db, _0x1c5ca6) {
    _0x3da6cc.call(this, _0x296e51, _0xaf6db9, _0x35a12d, _0x5dd1db);
    this.oid = _0x1c5ca6;
    this.state = _0x36be10.STATE.RUN;
    this.sprite = this.state.SPRITE[0x0];
    this.anim = 0x0;
    this.health = _0x36be10.HEALTH;
    this.bonkTimer = 0x0;
    this.dim = _0x26de58.make(0x2, 0x2);
    this.fallSpeed = this.moveSpeed = 0x0;
    this.grounded = !0x1;
    this.loc = [this.pos.x, this.pos.x - _0x36be10.MOVE_AREA];
...
_0x36be10.ASYNC = !0x0;
_0x36be10.ID = 0x19;
_0x36be10.NAME = "BOWSER";
_0x36be10.ANIMATION_RATE = 0x5;
_0x36be10.HEALTH = 0x5;
_0x36be10.BONK_TIME = 0x5a;
_0x36be10.BONK_IMP = _0x26de58.make(0.25, 0.4);
_0x36be10.BONK_DECEL = 0.925;
_0x36be10.BONK_FALL_SPEED = 0.5;
_0x36be10.MOVE_SPEED_MAX = 0.095;
_0x36be10.JUMP_DELAY = 0x2d;
_0x36be10.MOVE_AREA = 0x5;
_0x36be10.JUMP_LENGTH = 0x6;
_0x36be10.JUMP_DECEL = 0.009;
_0x36be10.ATTACK_DELAY = 0x4b;
_0x36be10.ATTACK_ANIM_LENGTH = 0xf;
_0x36be10.PROJ_OFFSET = _0x26de58.make(-0.25, 0.25);
_0x36be10.FALL_SPEED_MAX = 0.3;
_0x36be10.FALL_SPEED_ACCEL = 0.085;
_0x36be10.SPRITE = {};
_0x36be10.SPRITE_LIST = [{
    'NAME': "RUN0",
    'ID': 0x0,
    'INDEX': [
        [0xc4, 0xc5],
...
for (_0x1bec55 = 0x0; _0x1bec55 < _0x36be10.SPRITE_LIST.length; _0x1bec55++) _0x36be10.SPRITE[_0x36be10.SPRITE_LIST[_0x1bec55].NAME] = _0x36be10.SPRITE_LIST[_0x1bec55], _0x36be10.SPRITE[_0x36be10.SPRITE_LIST[_0x1bec55].ID] = _0x36be10.SPRITE_LIST[_0x1bec55];
_0x36be10.STATE = {};
_0x36be10.STATE_LIST = [{
    'NAME': "RUN",
    'ID': 0x0,
    'SPRITE': [_0x36be10.SPRITE.RUN0, _0x36be10.SPRITE.RUN1]
}, {
    'NAME': "ATTACK",
    'ID': 0x1,
    'SPRITE': [_0x36be10.SPRITE.ATTACK0, _0x36be10.SPRITE.ATTACK1]
}, {
    'NAME': "BONK",
    'ID': 0x51,
    'SPRITE': []
}];
for (_0x1bec55 = 0x0; _0x1bec55 < _0x36be10.STATE_LIST.length; _0x1bec55++) _0x36be10.STATE[_0x36be10.STATE_LIST[_0x1bec55].NAME] = _0x36be10.STATE_LIST[_0x1bec55], _0x36be10.STATE[_0x36be10.STATE_LIST[_0x1bec55].ID] = _0x36be10.STATE_LIST[_0x1bec55];
_0x36be10.prototype.update = function(_0x45393d) {};
_0x36be10.prototype.step = function() {
    this.state === _0x36be10.STATE.BONK ? this.bonkTimer++ > _0x36be10.BONK_TIME || 0x0 > this.pos.y + this.dim.y ? this.destroy() : (this.pos = _0x26de58.add(this.pos, _0x26de58.make(this.moveSpeed, this.fallSpeed)), this.moveSpeed *= _0x36be10.BONK_DECEL, this.fallSpeed = Math.max(this.fallSpeed - _0x36be10.FALL_SPEED_ACCEL, -_0x36be10.BONK_FALL_SPEED)) : (this.anim++, this.sprite = this.state.SPRITE[parseInt(this.anim / _0x36be10.ANIMATION_RATE) % this.state.SPRITE.length], this.control(), this.physics(), this.sound(), this.attackTimer++ > _0x36be10.ATTACK_DELAY && this.attack(), 0x0 < this.attackAnimTimer ? (this.setState(_0x36be10.STATE.ATTACK), this.attackAnimTimer--) : this.setState(_0x36be10.STATE.RUN), 0x0 > this.pos.y && this.destroy());
};
_0x36be10.prototype.control = function() {
    this.grounded ? (_0x36be10.JUMP_DELAY < this.groundTimer++ && (this.groundTimer = this.jumpTimer = 0x0), this.pos.x > this.loc[0x0] ? this.reverse = !0x0 : this.pos.x < this.loc[0x1] && (this.reverse = !0x1)) : this.jumpTimer > _0x36be10.JUMP_LENGTH && (this.jumpTimer = -0x1);
    this.moveSpeed = 0.75 * this.moveSpeed + 0.25 * (this.reverse ? -_0x36be10.MOVE_SPEED_MAX : _0x36be10.MOVE_SPEED_MAX);
};
_0x36be10.prototype.physics = function() {
    -0x1 !== this.jumpTimer ? (this.fallSpeed = _0x36be10.FALL_SPEED_MAX - this.jumpTimer * _0x36be10.JUMP_DECEL, this.jumpTimer++, this.grounded = !0x1) : (this.grounded && (this.fallSpeed = 0x0), this.fallSpeed = Math.max(this.fallSpeed - _0x36be10.FALL_SPEED_ACCEL, -_0x36be10.FALL_SPEED_MAX));
...
_0x36be10.prototype.sound = _0x3da6cc.prototype.sound;
_0x36be10.prototype.attack = function() {
    this.attackAnimTimer = _0x36be10.ATTACK_ANIM_LENGTH;
    this.attackTimer = 0x0;
    this.game.createObject(_0x1899b7.ID, this.level, this.zone, _0x26de58.add(this.pos, _0x36be10.PROJ_OFFSET), []);
    this.play("sfx/breath.wav", 1.5, 0.04);
};
_0x36be10.prototype.playerCollide = function(_0x30ea43) {
    this.dead || this.garbage || _0x30ea43.damage(this);
};
_0x36be10.prototype.playerStomp = _0x36be10.prototype.playerCollide;
_0x36be10.prototype.playerBump = _0x36be10.prototype.playerCollide;
_0x36be10.prototype.damage = function(_0x25178b) {
    this.dead || 0x0 >= --this.health && this.bonk();
};
_0x36be10.prototype.bonk = function() {
    this.dead || (this.setState(_0x36be10.STATE.BONK), this.moveSpeed = _0x36be10.BONK_IMP.x, this.fallSpeed = _0x36be10.BONK_IMP.y, this.dead = !0x0, this.play("sfx/kick.wav", 0x1, 0.04));
};
_0x36be10.prototype.kill = function() {};
_0x36be10.prototype.isTangible = _0x3da6cc.prototype.isTangible;
_0x36be10.prototype.destroy = _0x3da6cc.prototype.destroy;
_0x36be10.prototype.setState = function(_0x19037e) {
    _0x19037e !== this.state && (this.state = _0x19037e, 0x0 < _0x19037e.SPRITE.length && (this.sprite = _0x19037e.SPRITE[0x0]), this.anim = 0x0);
};
_0x36be10.prototype.draw = function(_0xdf4ab3) {
    var _0x21f360;
    _0x21f360 = this.state === _0x36be10.STATE.BONK ? 0x3 : 0x0;
    if (this.sprite.INDEX instanceof Array)
...
_0x36be10.prototype.play = _0x3da6cc.prototype.play;
_0x3da6cc.REGISTER_OBJECT(_0x36be10);
"use strict";
...
function _0x47285d(_0x9d9b10, _0x5d6af4, _0x14b8a1, _0x25d330, _0x2899a3) {
    _0x3da6cc.call(this, _0x9d9b10, _0x5d6af4, _0x14b8a1, _0x25d330);
    this.oid = _0x2899a3;
    this.setState(_0x47285d.STATE.EXTEND);
    this.anim = 0x0;
    this.pos = _0x26de58.add(this.pos, _0x47285d.SOFFSET);
    this.dim = _0x26de58.make(0.8, 0x2);
}
_0x47285d.ASYNC = !0x0;
_0x47285d.ID = 0x95;
_0x47285d.NAME = "SPRING";
_0x47285d.ANIMATION_RATE = 0x3;
_0x47285d.SOFFSET = _0x26de58.make(0.1, 0x0);
_0x47285d.THRESHOLD = [0x1, 0.5];
_0x47285d.POWER = 0.45;
_0x47285d.SPRITE = {};
_0x47285d.SPRITE_LIST = [{
    'NAME': "STAGE0",
    'ID': 0x0,
    'INDEX': [
        [0xa1],
...
for (_0x1bec55 = 0x0; _0x1bec55 < _0x47285d.SPRITE_LIST.length; _0x1bec55++) _0x47285d.SPRITE[_0x47285d.SPRITE_LIST[_0x1bec55].NAME] = _0x47285d.SPRITE_LIST[_0x1bec55], _0x47285d.SPRITE[_0x47285d.SPRITE_LIST[_0x1bec55].ID] = _0x47285d.SPRITE_LIST[_0x1bec55];
_0x47285d.STATE = {};
_0x47285d.STATE_LIST = [{
    'NAME': "EXTEND",
    'ID': 0x0,
    'SPRITE': [_0x47285d.SPRITE.STAGE0]
}, {
    'NAME': "HALF",
    'ID': 0x1,
    'SPRITE': [_0x47285d.SPRITE.STAGE1]
}, {
    'NAME': "COMPRESS",
    'ID': 0x2,
    'SPRITE': [_0x47285d.SPRITE.STAGE2]
}];
for (_0x1bec55 = 0x0; _0x1bec55 < _0x47285d.STATE_LIST.length; _0x1bec55++) _0x47285d.STATE[_0x47285d.STATE_LIST[_0x1bec55].NAME] = _0x47285d.STATE_LIST[_0x1bec55], _0x47285d.STATE[_0x47285d.STATE_LIST[_0x1bec55].ID] = _0x47285d.STATE_LIST[_0x1bec55];
_0x47285d.prototype.update = function(_0x348375) {};
_0x47285d.prototype.step = function() {
    this.anim++;
    this.sprite = this.state.SPRITE[parseInt(this.anim / _0x47285d.ANIMATION_RATE) % this.state.SPRITE.length];
    this.interaction();
};
_0x47285d.prototype.interaction = function() {
    ...
    if (_0x4c2d7a && _0x4c2d7a.level === this.level && _0x4c2d7a.zone === this.zone && _0x4c2d7a.isTangible() && _0x1badb6.intersection(this.pos, this.dim, _0x4c2d7a.pos, _0x4c2d7a.dim)) {
        ...
        _0x4c2d7a.fallSpeed >= 0.75 * _0x27b379.FALL_SPEED_MAX && _0x4c2d7a.btnA && (_0x4c2d7a.jumping = 0x0, _0x4c2d7a.isSpring = !0x0);
        _0x4c2d7a.fallSpeed += Math.min(0x2 * _0x27b379.FALL_SPEED_MAX, _0x370dd9 * _0x47285d.POWER);
    ...
    for (_0x370dd9 = 0x0; _0x370dd9 < this.game.objects.length; _0x370dd9++) {
        ...
        _0x3645c3 instanceof _0x27b379 && _0x3645c3.level === this.level && _0x3645c3.zone === this.zone && _0x3645c3.isTangible() && _0x1badb6.intersection(this.pos, this.dim, _0x3645c3.pos, _0x3645c3.dim) && (_0x3645c3 = Math.min(Math.max(0x0, _0x3645c3.pos.y - this.pos.y), 0x2), _0x3645c3 < _0x4c2d7a && (_0x4c2d7a = _0x3645c3));
    }
    _0x4c2d7a < _0x47285d.THRESHOLD[0x1] ? this.setState(_0x47285d.STATE.COMPRESS) : _0x4c2d7a < _0x47285d.THRESHOLD[0x0] ? this.setState(_0x47285d.STATE.HALF) : this.setState(_0x47285d.STATE.EXTEND);
};
_0x47285d.prototype.kill = function() {};
_0x47285d.prototype.destroy = _0x3da6cc.prototype.destroy;
_0x47285d.prototype.isTangible = _0x3da6cc.prototype.isTangible;
_0x47285d.prototype.setState = function(_0x18377f) {
    _0x18377f !== this.state && (this.state = _0x18377f, this.sprite = _0x18377f.SPRITE[0x0], this.anim = 0x0);
};
_0x47285d.prototype.draw = function(_0x132bc0) {
    if (this.sprite.INDEX instanceof Array)
        for (var _0x3191ef = this.sprite.INDEX, _0x4714a0 = 0x0; _0x4714a0 < _0x3191ef.length; _0x4714a0++)
            for (var _0x507d31 = 0x0; _0x507d31 < _0x3191ef[_0x4714a0].length; _0x507d31++) _0x132bc0.push({
                'pos': _0x26de58.subtract(_0x26de58.add(this.pos, _0x26de58.make(_0x507d31, _0x4714a0)), _0x47285d.SOFFSET),
                'reverse': !0x1,
                'index': _0x3191ef[_0x4714a0][_0x507d31]
            });
    else _0x132bc0.push({
        'pos': _0x26de58.subtract(this.pos, _0x47285d.SOFFSET),
        'reverse': !0x1,
        'index': this.sprite.INDEX,
        'mode': 0x0
    });
};
_0x3da6cc.REGISTER_OBJECT(_0x47285d);
"use strict";
...
_0x6c6f53.prototype.interaction = function() {
    for (var _0x51d7a3 = 0x0; _0x51d7a3 < this.game.objects.length; _0x51d7a3++) {
        ...
        if (_0x1f6129 !== this && _0x1f6129.pid !== this.owner && _0x1f6129.isTangible() && !(_0x1f6129 instanceof _0x27b379) && _0x1f6129.damage && _0x1f6129.level === this.level && _0x1f6129.zone === this.zone && _0x1badb6.intersection(_0x1f6129.pos, _0x1f6129.dim, this.pos, this.dim)) {
...
_0x1899b7.prototype.interaction = function() {
    for (var _0x554db7 = 0x0; _0x554db7 < this.game.objects.length; _0x554db7++) {
        ...
        if (_0x43845d instanceof _0x27b379 && _0x43845d.isTangible() && _0x43845d.level === this.level && _0x43845d.zone === this.zone && _0x1badb6.intersection(_0x43845d.pos, _0x43845d.dim, this.pos, this.dim)) {
...
function _0x2a84ef(_0x1d612b, _0x30e50f, _0x5ea008, _0xaa5aa6, _0x2e3285) {
    _0x2e2bc3.call(this, _0x1d612b, _0x30e50f, _0x5ea008, _0xaa5aa6, _0x2e3285);
    this.state = _0x2a84ef.STATE.IDLE;
    this.sprite = this.state.SPRITE[0x0];
}
_0x2a84ef.ASYNC = !0x1;
_0x2a84ef.ID = 0x51;
_0x2a84ef.NAME = "MUSHROOM";
_0x2a84ef.SPRITE = {};
_0x2a84ef.SPRITE_LIST = [{
    'NAME': "IDLE",
    'ID': 0x0,
    'INDEX': 0xe9
}];
for (_0x1bec55 = 0x0; _0x1bec55 < _0x2a84ef.SPRITE_LIST.length; _0x1bec55++) _0x2a84ef.SPRITE[_0x2a84ef.SPRITE_LIST[_0x1bec55].NAME] = _0x2a84ef.SPRITE_LIST[_0x1bec55], _0x2a84ef.SPRITE[_0x2a84ef.SPRITE_LIST[_0x1bec55].ID] = _0x2a84ef.SPRITE_LIST[_0x1bec55];
_0x2a84ef.STATE = {};
_0x2a84ef.STATE_LIST = [{
    'NAME': "IDLE",
    'ID': 0x0,
    'SPRITE': [_0x2a84ef.SPRITE.IDLE]
}];
for (_0x1bec55 = 0x0; _0x1bec55 < _0x2a84ef.STATE_LIST.length; _0x1bec55++) _0x2a84ef.STATE[_0x2a84ef.STATE_LIST[_0x1bec55].NAME] = _0x2a84ef.STATE_LIST[_0x1bec55], _0x2a84ef.STATE[_0x2a84ef.STATE_LIST[_0x1bec55].ID] = _0x2a84ef.STATE_LIST[_0x1bec55];
_0x2a84ef.prototype.update = _0x2e2bc3.prototype.update;
_0x2a84ef.prototype.step = _0x2e2bc3.prototype.step;
_0x2a84ef.prototype.control = function() {
    _0x2e2bc3.prototype.control.call(this);
    this.moveSpeed = this.dir ? -_0x2e2bc3.MOVE_SPEED_MAX : _0x2e2bc3.MOVE_SPEED_MAX;
};
_0x2a84ef.prototype.physics = _0x2e2bc3.prototype.physics;
_0x2a84ef.prototype.bounce = _0x2e2bc3.prototype.bounce;
_0x2a84ef.prototype.playerCollide = _0x2e2bc3.prototype.playerCollide;
_0x2a84ef.prototype.playerStomp = _0x2e2bc3.prototype.playerStomp;
_0x2a84ef.prototype.playerBump = _0x2e2bc3.prototype.playerBump;
_0x2a84ef.prototype.kill = _0x2e2bc3.prototype.kill;
_0x2a84ef.prototype.destroy = _0x3da6cc.prototype.destroy;
_0x2a84ef.prototype.isTangible = _0x3da6cc.prototype.isTangible;
_0x2a84ef.prototype.setState = _0x2e2bc3.prototype.setState;
_0x2a84ef.prototype.draw = _0x2e2bc3.prototype.draw;
_0x3da6cc.REGISTER_OBJECT(_0x2a84ef);
"use strict";

function _0x42d5d2(_0x4e64ba, _0x1fe145, _0x5b661a, _0x556dbf, _0x4f6437) {
    _0x2e2bc3.call(this, _0x4e64ba, _0x1fe145, _0x5b661a, _0x556dbf, _0x4f6437);
    this.state = _0x42d5d2.STATE.IDLE;
    this.sprite = this.state.SPRITE[0x0];
}
_0x42d5d2.ASYNC = !0x1;
_0x42d5d2.ID = 0x52;
_0x42d5d2.NAME = "FIRE FLOWER";
_0x42d5d2.SPRITE = {};
_0x42d5d2.SPRITE_LIST = [{
    'NAME': "IDLE0",
    'ID': 0x0,
    'INDEX': 0xe4
}, {
...
for (_0x1bec55 = 0x0; _0x1bec55 < _0x42d5d2.SPRITE_LIST.length; _0x1bec55++) _0x42d5d2.SPRITE[_0x42d5d2.SPRITE_LIST[_0x1bec55].NAME] = _0x42d5d2.SPRITE_LIST[_0x1bec55], _0x42d5d2.SPRITE[_0x42d5d2.SPRITE_LIST[_0x1bec55].ID] = _0x42d5d2.SPRITE_LIST[_0x1bec55];
_0x42d5d2.STATE = {};
_0x42d5d2.STATE_LIST = [{
    'NAME': "IDLE",
    'ID': 0x0,
    'SPRITE': [_0x42d5d2.SPRITE.IDLE0, _0x42d5d2.SPRITE.IDLE1, _0x42d5d2.SPRITE.IDLE2, _0x42d5d2.SPRITE.IDLE3]
}];
for (_0x1bec55 = 0x0; _0x1bec55 < _0x42d5d2.STATE_LIST.length; _0x1bec55++) _0x42d5d2.STATE[_0x42d5d2.STATE_LIST[_0x1bec55].NAME] = _0x42d5d2.STATE_LIST[_0x1bec55], _0x42d5d2.STATE[_0x42d5d2.STATE_LIST[_0x1bec55].ID] = _0x42d5d2.STATE_LIST[_0x1bec55];
_0x42d5d2.prototype.update = _0x2e2bc3.prototype.update;
_0x42d5d2.prototype.step = _0x2e2bc3.prototype.step;
_0x42d5d2.prototype.control = function() {};
_0x42d5d2.prototype.physics = _0x2e2bc3.prototype.physics;
_0x42d5d2.prototype.playerCollide = _0x2e2bc3.prototype.playerCollide;
_0x42d5d2.prototype.playerStomp = _0x2e2bc3.prototype.playerStomp;
_0x42d5d2.prototype.playerBump = _0x2e2bc3.prototype.playerBump;
_0x42d5d2.prototype.kill = _0x2e2bc3.prototype.kill;
_0x42d5d2.prototype.destroy = _0x3da6cc.prototype.destroy;
_0x42d5d2.prototype.isTangible = _0x3da6cc.prototype.isTangible;
_0x42d5d2.prototype.setState = _0x2e2bc3.prototype.setState;
_0x42d5d2.prototype.draw = _0x2e2bc3.prototype.draw;
_0x3da6cc.REGISTER_OBJECT(_0x42d5d2);
"use strict";

function _0x328b6a(_0x375784, _0x5a5c7c, _0xa508b, _0x131d1e, _0x44782e) {
    _0x2e2bc3.call(this, _0x375784, _0x5a5c7c, _0xa508b, _0x131d1e, _0x44782e);
    this.state = _0x328b6a.STATE.IDLE;
    this.sprite = this.state.SPRITE[0x0];
...
_0x328b6a.ID = 0x54;
_0x328b6a.NAME = "STAR";
_0x328b6a.JUMP_LENGTH = 0x6;
_0x328b6a.MOVE_SPEED_MAX = 0.125;
_0x328b6a.JUMP_DELAY = 0x2;
_0x328b6a.SPRITE = {};
_0x328b6a.SPRITE_LIST = [{
    'NAME': "IDLE0",
    'ID': 0x0,
    'INDEX': 0xe0
}, {
...
for (_0x1bec55 = 0x0; _0x1bec55 < _0x328b6a.SPRITE_LIST.length; _0x1bec55++) _0x328b6a.SPRITE[_0x328b6a.SPRITE_LIST[_0x1bec55].NAME] = _0x328b6a.SPRITE_LIST[_0x1bec55], _0x328b6a.SPRITE[_0x328b6a.SPRITE_LIST[_0x1bec55].ID] = _0x328b6a.SPRITE_LIST[_0x1bec55];
_0x328b6a.STATE = {};
_0x328b6a.STATE_LIST = [{
    'NAME': "IDLE",
    'ID': 0x0,
    'SPRITE': [_0x328b6a.SPRITE.IDLE0, _0x328b6a.SPRITE.IDLE1, _0x328b6a.SPRITE.IDLE2, _0x328b6a.SPRITE.IDLE3]
}];
for (_0x1bec55 = 0x0; _0x1bec55 < _0x328b6a.STATE_LIST.length; _0x1bec55++) _0x328b6a.STATE[_0x328b6a.STATE_LIST[_0x1bec55].NAME] = _0x328b6a.STATE_LIST[_0x1bec55], _0x328b6a.STATE[_0x328b6a.STATE_LIST[_0x1bec55].ID] = _0x328b6a.STATE_LIST[_0x1bec55];
_0x328b6a.prototype.update = _0x2e2bc3.prototype.update;
_0x328b6a.prototype.step = _0x2e2bc3.prototype.step;
_0x328b6a.prototype.control = function() {
    this.moveSpeed = this.dir ? -_0x328b6a.MOVE_SPEED_MAX : _0x328b6a.MOVE_SPEED_MAX;
    this.grounded && ++this.groundTimer >= _0x328b6a.JUMP_DELAY ? this.jump = 0x0 : this.jump > _0x328b6a.JUMP_LENGTH && (this.jump = -0x1, this.groundTimer = 0x0);
};
_0x328b6a.prototype.physics = _0x2e2bc3.prototype.physics;
_0x328b6a.prototype.bounce = _0x2e2bc3.prototype.bounce;
_0x328b6a.prototype.playerCollide = _0x2e2bc3.prototype.playerCollide;
_0x328b6a.prototype.playerStomp = _0x2e2bc3.prototype.playerStomp;
_0x328b6a.prototype.playerBump = _0x2e2bc3.prototype.playerBump;
_0x328b6a.prototype.kill = _0x2e2bc3.prototype.kill;
_0x328b6a.prototype.destroy = _0x3da6cc.prototype.destroy;
_0x328b6a.prototype.isTangible = _0x3da6cc.prototype.isTangible;
_0x328b6a.prototype.setState = _0x2e2bc3.prototype.setState;
_0x328b6a.prototype.draw = _0x2e2bc3.prototype.draw;
_0x3da6cc.REGISTER_OBJECT(_0x328b6a);
"use strict";

function _0x515a84(_0x1fd5d8, _0x3fd6ae, _0x16274e, _0x3cab6e, _0x53f924) {
    _0x2e2bc3.call(this, _0x1fd5d8, _0x3fd6ae, _0x16274e, _0x3cab6e, _0x53f924);
    this.state = _0x515a84.STATE.IDLE;
    this.sprite = this.state.SPRITE[0x0];
}
_0x515a84.ASYNC = !0x1;
_0x515a84.ID = 0x53;
_0x515a84.NAME = "ONEUP";
_0x515a84.SPRITE = {};
_0x515a84.SPRITE_LIST = [{
    'NAME': "IDLE",
    'ID': 0x0,
    'INDEX': 0xe8
}];
for (_0x1bec55 = 0x0; _0x1bec55 < _0x515a84.SPRITE_LIST.length; _0x1bec55++) _0x515a84.SPRITE[_0x515a84.SPRITE_LIST[_0x1bec55].NAME] = _0x515a84.SPRITE_LIST[_0x1bec55], _0x515a84.SPRITE[_0x515a84.SPRITE_LIST[_0x1bec55].ID] = _0x515a84.SPRITE_LIST[_0x1bec55];
_0x515a84.STATE = {};
_0x515a84.STATE_LIST = [{
    'NAME': "IDLE",
    'ID': 0x0,
    'SPRITE': [_0x515a84.SPRITE.IDLE]
}];
for (_0x1bec55 = 0x0; _0x1bec55 < _0x515a84.STATE_LIST.length; _0x1bec55++) _0x515a84.STATE[_0x515a84.STATE_LIST[_0x1bec55].NAME] = _0x515a84.STATE_LIST[_0x1bec55], _0x515a84.STATE[_0x515a84.STATE_LIST[_0x1bec55].ID] = _0x515a84.STATE_LIST[_0x1bec55];
_0x515a84.prototype.update = _0x2e2bc3.prototype.update;
_0x515a84.prototype.step = _0x2e2bc3.prototype.step;
_0x515a84.prototype.control = function() {
    _0x2e2bc3.prototype.control.call(this);
    this.moveSpeed = this.dir ? -_0x2e2bc3.MOVE_SPEED_MAX : _0x2e2bc3.MOVE_SPEED_MAX;
};
_0x515a84.prototype.physics = _0x2e2bc3.prototype.physics;
_0x515a84.prototype.bounce = _0x2e2bc3.prototype.bounce;
_0x515a84.prototype.playerCollide = _0x2e2bc3.prototype.playerCollide;
_0x515a84.prototype.playerStomp = _0x2e2bc3.prototype.playerStomp;
_0x515a84.prototype.playerBump = _0x2e2bc3.prototype.playerBump;
_0x515a84.prototype.kill = _0x2e2bc3.prototype.kill;
_0x515a84.prototype.destroy = _0x3da6cc.prototype.destroy;
_0x515a84.prototype.isTangible = _0x3da6cc.prototype.isTangible;
_0x515a84.prototype.setState = _0x2e2bc3.prototype.setState;
_0x515a84.prototype.draw = _0x2e2bc3.prototype.draw;
_0x3da6cc.REGISTER_OBJECT(_0x515a84);
"use strict";
...
_0x2aba82.prototype.playerCollide = function(_0x250479) {
    if (!(this.dead || this.garbage || this.used))
        for (_0x250479.powerup(this), this.used = !0x0, _0x250479 = 0x0; _0x250479 < this.game.objects.length; _0x250479++) {
            ...
            if (_0x2ea61e instanceof _0x36be10 && _0x2ea61e.level === this.level && _0x2ea61e.zone === _0x2ea61e.zone && !_0x2ea61e.dead) {
                _0x2ea61e.bonk();
                break;
            }
        }
...
function _0x5bd111(_0x52a861, _0x4a48fc, _0x331cc6, _0x11bbb6, _0x11c124) {
    _0x3da6cc.call(this, _0x52a861, _0x4a48fc, _0x331cc6, _0x11bbb6);
    this.oid = _0x11c124;
    this.state = _0x5bd111.STATE.IDLE;
    this.sprite = this.state.SPRITE[0x0];
    this.anim = 0x0;
    this.dim = _0x26de58.make(0x1, 0x1);
}
...
_0x5bd111.ID = 0x61;
_0x5bd111.NAME = "COIN";
_0x5bd111.ANIMATION_RATE = 0x5;
_0x5bd111.SPRITE = {};
_0x5bd111.SPRITE_LIST = [{
    'NAME': "IDLE0",
    'ID': 0x0,
    'INDEX': 0xf0
}, {
...
for (_0x1bec55 = 0x0; _0x1bec55 < _0x5bd111.SPRITE_LIST.length; _0x1bec55++) _0x5bd111.SPRITE[_0x5bd111.SPRITE_LIST[_0x1bec55].NAME] = _0x5bd111.SPRITE_LIST[_0x1bec55], _0x5bd111.SPRITE[_0x5bd111.SPRITE_LIST[_0x1bec55].ID] = _0x5bd111.SPRITE_LIST[_0x1bec55];
_0x5bd111.STATE = {};
_0x5bd111.STATE_LIST = [{
    'NAME': "IDLE",
    'ID': 0x0,
    'SPRITE': [_0x5bd111.SPRITE.IDLE0, _0x5bd111.SPRITE.IDLE1, _0x5bd111.SPRITE.IDLE2, _0x5bd111.SPRITE.IDLE3]
}];
for (_0x1bec55 = 0x0; _0x1bec55 < _0x5bd111.STATE_LIST.length; _0x1bec55++) _0x5bd111.STATE[_0x5bd111.STATE_LIST[_0x1bec55].NAME] = _0x5bd111.STATE_LIST[_0x1bec55], _0x5bd111.STATE[_0x5bd111.STATE_LIST[_0x1bec55].ID] = _0x5bd111.STATE_LIST[_0x1bec55];
_0x5bd111.prototype.update = function(_0x376de4) {
    switch (_0x376de4) {
        case 0x0:
            this.kill();
    }
};
_0x5bd111.prototype.step = function() {
    this.anim++;
    this.sprite = this.state.SPRITE[parseInt(this.anim / _0x5bd111.ANIMATION_RATE) % this.state.SPRITE.length];
};
_0x5bd111.prototype.playerCollide = function(_0x143dba) {
...
_0x5bd111.prototype.playerStomp = function(_0x423f28) {
    this.playerCollide(_0x423f28);
};
_0x5bd111.prototype.playerBump = function(_0x298d70) {
    this.playerCollide(_0x298d70);
};
_0x5bd111.prototype.kill = function() {
    this.dead = !0x0;
    this.destroy();
};
_0x5bd111.prototype.isTangible = _0x3da6cc.prototype.isTangible;
_0x5bd111.prototype.destroy = _0x3da6cc.prototype.destroy;
_0x5bd111.prototype.setState = function(_0x4e1f82) {
    _0x4e1f82 !== this.state && (this.state = _0x4e1f82, this.sprite = _0x4e1f82.SPRITE[0x0], this.anim = 0x0);
};
_0x5bd111.prototype.draw = function(_0x157dc2) {
    _0x157dc2.push({
        'pos': this.pos,
        'reverse': this.reverse,
        'index': this.sprite.INDEX,
...
_0x3da6cc.REGISTER_OBJECT(_0x5bd111);
"use strict";
...
_0x108200.prototype.step = function() {
    _0x403fef.prototype.step.call(this);
    this.sprite = _0x108200.SPRITE[parseInt(this.anim++/_0x108200.ANIMATION_RATE)%_0x108200.SPRITE.length];this.bits[0x0].pos.y=this.life>=_0x108200.DOWN_TIME?this.bits[0x0].pos.y+_0x108200.MOVE_SPEED:this.bits[0x0].pos.y-_0x108200.MOVE_SPEED;};_0x108200.prototype.destroy=_0x403fef.prototype.destroy;_0x108200.prototype.draw=function(_0x198af3){for(var _0x148e46=0x0;_0x148e46<this.bits.length;_0x148e46++){var _0x50b29b=this.bits[_0x148e46];_0x198af3.push({'tex':"obj",'ind':this.sprite,'pos':_0x50b29b.pos,'off':_0x50b29b.so,'rot':0x0,'sp':_0x50b29b.sp,'ss':_0x50b29b.ss});}};"use strict";function _0x2406bb(_0x4377d5,_0x141691){this.game=_0x4377d5;this.container=_0x141691;var _0x3b9d05=this;this.container.onmousemove=function(_0x4377d5){_0x3b9d05.mouse.event(_0x4377d5);};this.container.onmousedown=function(_0x4377d5){_0x3b9d05.mouse.event(_0x4377d5,!0x0);};this.container.onmouseup=function(_0x4377d5){_0x3b9d05.mouse.event(_0x4377d5,!0x1);};this.container.addEventListener("mousewheel",function(_0x4377d5){_0x3b9d05.mouse.wheel(_0x4377d5);},!0x1);this.container.addEventListener("DOMMouseScroll",function(_0x4377d5){_0x3b9d05.mouse.wheel(_0x4377d5);},!0x1);document.onkeyup=function(_0x4377d5){_0x3b9d05.keyboard.event(_0x4377d5,!0x1);};document.onkeydown=function(_0x4377d5){_0x3b9d05.keyboard.event(_0x4377d5,!0x0);};this.touchEvt=function(_0x4377d5){_0x37bd58.game.input.touch.event(_0x4377d5);};document.addEventListener("touchstart",this.touchEvt,!0x0);document.addEventListener("touchmove",this.touchEvt,!0x0);document.addEventListener("touchend",this.touchEvt,!0x0);this.mouse.input=this;this.keyboard.input=this;this.touch.input=this;this.load();}_0x2406bb.INPUTS="up down left right a b".split('\x20');_0x2406bb.K_DEFAULT=[0x57,0x53,0x41,0x44,0x20,0x10];_0x2406bb.G_DEFAULT=[0x0,0x1,0x2,0x3,0x4,0x5];_0x2406bb.prototype.load=function(){this.assignK={};for(var _0x586200=0x0;_0x586200<_0x2406bb.INPUTS.length;_0x586200++){var _0x237481=Cookies.get('k_'+_0x2406bb.INPUTS[_0x586200]);this.assignK[_0x2406bb.INPUTS[_0x586200]]=_0x237481?parseInt(_0x237481):_0x2406bb.K_DEFAULT[_0x586200];}this.assignG={};for(_0x586200=0x0;_0x586200<_0x2406bb.INPUTS.length;_0x586200++)_0x237481=Cookies.get('g_'+_0x2406bb.INPUTS[_0x586200]),this.assignG[_0x2406bb.INPUTS[_0x586200]]=_0x237481?parseInt(_0x237481):_0x2406bb.G_DEFAULT[_0x586200];};_0x2406bb.prototype.pad={};_0x2406bb.prototype.pad.pad=void 0x0;_0x2406bb.prototype.pad.ax=_0x26de58.make(0x0,0x0);_0x2406bb.prototype.pad.update=function(){this.pad=navigator?navigator.getGamepads()[0x0]:void 0x0;this.analog();};_0x2406bb.prototype.pad.analog=function(){if(this.pad)for(var _0x3e7abb=0x0;_0x3e7abb<this.pad.axes.length-0x1;_0x3e7abb++){var _0xe40132=this.pad.axes[_0x3e7abb],_0x5f2255=this.pad.axes[_0x3e7abb+0x1];if(!(0.25>Math.abs(_0xe40132)&&0.25>Math.abs(_0x5f2255))){this.ax=_0x26de58.make(_0xe40132,_0x5f2255);return;}}this.ax=_0x26de58.make(0x0,0x0);};_0x2406bb.prototype.pad.button=function(_0x2cedc3){return this.pad?this.pad.buttons[_0x2cedc3].pressed:!0x1;};_0x2406bb.prototype.pad.connected=function(){return!!this.pad;};_0x2406bb.prototype.mouse={};_0x2406bb.prototype.mouse.inputs=[];_0x2406bb.prototype.mouse.pos={};_0x2406bb.prototype.mouse.mov={};_0x2406bb.prototype.mouse.spin=0x0;_0x2406bb.prototype.mouse.nxtMov={};_0x2406bb.prototype.mouse.nxtSpin=0x0;_0x2406bb.prototype.mouse.lmb=!0x1;_0x2406bb.prototype.mouse.rmb=!0x1;_0x2406bb.prototype.mouse.mmb=!0x1;_0x2406bb.prototype.mouse.nxtMov.x=0x0;_0x2406bb.prototype.mouse.nxtMov.y=0x0;_0x2406bb.prototype.mouse.mov.x=0x0;_0x2406bb.prototype.mouse.mov.y=0x0;_0x2406bb.prototype.mouse.pos.x=0x0;_0x2406bb.prototype.mouse.pos.y=0x0;_0x2406bb.prototype.mouse.event=function(_0x2387e9,_0x570db5){this.nxtMov={};this.nxtMov.x=this.nxtMov.x+(this.pos.x-_0x2387e9.offsetX);this.nxtMov.y=this.nxtMov.y+-0x1*(this.pos.y-_0x2387e9.offsetY);this.pos={};this.pos.x=_0x2387e9.offsetX;this.pos.y=_0x2387e9.offsetY;if(void 0x0!==_0x570db5){switch(_0x2387e9.button){case 0x0:this.lmb=_0x570db5;break;case 0x2:this.rmb=_0x570db5;break;case 0x1:this.mmb=_0x570db5;}_0x570db5&&this.inputs.push({'btn':_0x2387e9.button,'pos':this.pos});}};_0x2406bb.prototype.mouse.wheel=function(_0x57a9b4){_0x57a9b4=window.event||_0x57a9b4;this.nxtSpin+=Math.max(-0x1,Math.min(0x1,_0x57a9b4.wheelDelta||-_0x57a9b4.detail));return!0x1;};_0x2406bb.prototype.keyboard={};_0x2406bb.prototype.keyboard.inputs=[];_0x2406bb.prototype.keyboard.keys=[];_0x2406bb.prototype.keyboard.event=function(_0x530753,_0x357844){(this.keys[_0x530753.keyCode]=_0x357844)&&this.inputs.push({'key':_0x530753.keyCode,'char':0x1!==_0x530753.key.length?'':_0x530753.key});};_0x2406bb.prototype.touch={};_0x2406bb.prototype.touch.inputs=[];_0x2406bb.prototype.touch.pos=[];_0x2406bb.prototype.touch.event=function(_0x1eb002){var _0x46fc03=this.pos;this.pos=[];for(var _0x4f7d71=0x0;_0x4f7d71<_0x1eb002.touches.length;_0x4f7d71++){for(var _0x526541=_0x1eb002.touches[_0x4f7d71],_0x235bae=!0x1,_0x5b0330=0x0;_0x5b0330<_0x46fc03.length;_0x5b0330++)if(_0x46fc03[_0x5b0330].id===_0x526541.identifier){_0x235bae=!0x0;break;}_0x235bae||this.inputs.push({'id':_0x526541.identifier,'x':_0x526541.clientX,'y':_0x526541.clientY});this.pos.push({'id':_0x526541.identifier,'x':_0x526541.clientX,'y':_0x526541.clientY});}};_0x2406bb.prototype.pop=function(){this.mouse.mov=this.mouse.nxtMov;this.mouse.spin=this.mouse.nxtSpin;this.mouse.nxtMov={};this.mouse.nxtMov.x=0x0;this.mouse.nxtMov.y=0x0;this.mouse.nxtSpin=0x0;var _0x48e61c={};_0x48e61c.mouse=this.mouse.inputs;_0x48e61c.keyboard=this.keyboard.inputs;_0x48e61c.touch=this.touch.inputs;this.keyboard.inputs=[];this.mouse.inputs=[];this.touch.inputs=[];return _0x48e61c;};_0x2406bb.prototype.destroy=function(){this.container.onmousemove=function(){};this.container.onmousedown=function(){};this.container.onmouseup=function(){};this.container.removeEventListener("mousewheel",this.mouse.wheel,!0x1);this.container.removeEventListener("DOMMouseScroll",this.mouse.wheel,!0x1);document.onkeyup=function(){};document.onkeydown=function(){};};"use strict";function _0x5073b0(_0x1cd634){this.texture={};this.texture.cache={};this.texture.load=0x0;this.load(_0x1cd634);}_0x5073b0.prototype.load=function(_0x5bfd6c){for(var _0x2073f3=0x0;_0x2073f3<_0x5bfd6c.length;_0x2073f3++){var _0xfd3465=_0x5bfd6c[_0x2073f3],_0x56bb39=_0xfd3465.src.split('.').pop().toLowerCase();switch(_0x56bb39){case "png":this.loadTexture(_0xfd3465);break;case "gif":this.loadTexture(_0xfd3465);break;default:_0x37bd58.menu.warn.show("Failed to load resource with unknown extension: "+_0x56bb39);}}};_0x5073b0.prototype.loadTexture=function(_0x157149){var _0x5f0f35=this.texture;if(!_0x5f0f35.cache[_0x157149.id]){var _0x332a5e=new Image();_0x332a5e.onload=function(){_0x5f0f35.cache[_0x157149.id]=_0x332a5e;_0x5f0f35.load--;};_0x332a5e.src=_0x157149.src+"?v=2.1.0";_0x5f0f35.load++;}};_0x5073b0.prototype.getTexture=function(_0x31e060){return this.texture.cache[_0x31e060];};_0x5073b0.prototype.ready=function(){return 0x0===this.texture.load;};"use strict";function _0x36be04(_0x450620){this.display=_0x450620;this.pos=_0x26de58.make(0x0,0x0);this.scale=0x3;}_0x36be04.MOVE_MULT=0.075;_0x36be04.ZOOM_MULT=0.075;_0x36be04.ZOOM_MAX=0x1;_0x36be04.ZOOM_MIN=0x8;_0x36be04.prototype.move=function(_0x1c8341){this.pos=_0x26de58.add(this.pos,_0x26de58.scale(_0x1c8341,0x1/this .scale * _0x36be04.MOVE_MULT));
};
...
function _0x1570ee(_0x2bb69a, _0x540c81) {
    this.path = _0x540c81;
    var _0x7aecd4 = this,
        _0x3843a0 = new XMLHttpRequest();
    _0x3843a0.open("GET", "audio/" + _0x540c81, !0x0);
    _0x3843a0.responseType = "arraybuffer";
    _0x3843a0.onload = function() {
        _0x7aecd4.onload(_0x3843a0, _0x2bb69a);
    };
    _0x3843a0.send();
}
_0x1570ee.prototype.onload = function(_0x1718ea, _0x586848) {
    var _0x200ebf = this;
    _0x586848.decodeAudioData(_0x1718ea.response, function(_0x1718ea) {
        _0x200ebf.buffer = _0x1718ea;
    }, _0x200ebf.onError);
};
_0x1570ee.prototype.onError = function() {};
_0x1570ee.prototype.ready = function() {
    return void 0x0 !== this.buffer;
};
_0x1570ee.prototype.destroy = function() {};
"use strict";
...
function _0x415c3a(_0x180462, _0x8d00db, _0x52fdb8, _0x50d225, _0x2664ab, _0x57e822) {
    ...
    this.data.ready() ? this.create(_0x50d225, _0x2664ab, _0x57e822) : _0x37bd58.menu.warn.show("Attempted to instance partially loaded sound data: '" + _0x8d00db + '\x27');
}
...
_0x415c3a.prototype.play = function() {
    this.ready && !this.played ? (this.source.start(0x0), this.playing = !0x0) : this.played && _0x37bd58.menu.warn.show("Attempted to replay sound instance: '" + this.path + '\x27');
    this.played = !0x0;
};
...
_0x551ffe.prototype.create = function(_0x515fcc, _0x3aa7bf, _0x2989cc) {
    ...
    this.panner.refDistance = _0x34262c.FALLOFF_MIN;
    this.panner.maxDistance = _0x34262c.FALLOFF_MAX;
...
_0x34262c.FALLOFF_MIN = 0x1;
_0x34262c.FALLOFF_MAX = 0x18;
_0x34262c.prototype.initWebAudio = function() {
    try {
        this.context = new(window[("AudioContext")] || window[("webkitAudioContext")])();
    } catch (_0x129d9c) {
        return _0x37bd58.menu.warn.show("WebAudio not supported. Intializing fallback mode..."), !0x1;
    }
    var _0x446832 = "sfx/alert.wav sfx/break.wav sfx/breath.wav sfx/bump.wav sfx/coin.wav sfx/fireball.wav sfx/firework.wav sfx/flagpole.wav sfx/item.wav sfx/jump0.wav sfx/jump1.wav sfx/kick.wav sfx/life.wav sfx/pipe.wav sfx/powerup.wav sfx/stomp.wav sfx/vine.wav music/main0.mp3 music/main1.mp3 music/main2.mp3 music/main3.mp3 music/level.mp3 music/castle.mp3 music/victory.mp3 music/star.mp3 music/dead.mp3 music/gameover.mp3".split('\x20');
    this.sounds = [];
    for (var _0x4bf7be = 0x0; _0x4bf7be < _0x446832.length; _0x4bf7be++)
        if (!this.createAudio(_0x446832[_0x4bf7be])) return !0x1;
...
_0x34262c.prototype.initFallback = function() {
    this.context = void 0x0;
    this.sounds = [];
};
_0x34262c.prototype.update = function() {
    this.updateVolume();
...
_0x34262c.prototype.updateVolume = function() {
    this.masterVolume.gain.value = 0.5;
    this.effectVolume.gain.value = this.muteSound ? 0x0 : 0.75;
    this.musicVolume.gain.value = this.muteMusic ? 0x0 : 0.5;
    if (!this.muteSound && !this.muteMusic) {
        for (var _0x1f6806 = this.game.getZone(), _0x1bcd11 = this.game.getPlayer() ? this.game.getPlayer().pos : this.game.display.camera.pos, _0x4531dc = 0x3e7, _0x9aa837 = 0x0; _0x9aa837 < this.game.objects.length; _0x9aa837++) {
            ...
            if (_0x21a62e instanceof _0x27b379 && _0x21a62e.level === _0x1f6806.level && _0x21a62e.zone === _0x1f6806.id && 0x0 < _0x21a62e.starTimer) {
                var _0x214eed = _0x26de58.distance(_0x1bcd11, _0x21a62e.pos);
                _0x214eed < _0x4531dc && (_0x4531dc = _0x214eed);
            }
        }
        _0x4531dc < _0x34262c.FALLOFF_MAX && (this.musicVolume.gain.value = 0.5 * Math.max(0x0, Math.min(0x1, Math.pow(_0x214eed / _0x34262c.FALLOFF_MAX, 0x2))));
    }
};
_0x34262c.prototype.saveSettings = function() {
...
_0x34262c.prototype.setMusic = function(_0x14a0c1, _0x478a92) {
    if (this.music) {
...
_0x34262c.prototype.stopMusic = function() {
    this.music && (this.music.stop(), this.music = void 0x0);
};
_0x34262c.prototype.createAudio = function(_0x308893) {
    _0x308893 = new _0x1570ee(this.context, _0x308893);
    this.sounds.push(_0x308893);
    return !0x0;
};
_0x34262c.prototype.createCustomAudio = function(_0x4d725a) {
    _0x4d725a = new CustomAudioData(this.context, _0x4d725a);
    this.sounds.push(_0x4d725a);
    return !0x0;
};
_0x34262c.prototype.getAudio = function(_0x5552c8, _0x1ecf0c, _0x35680c, _0xddf719) {
    switch (_0xddf719) {
        case "effect":
    ...
    _0x37bd58.menu.warn.show("Failed to load sound: '" + _0x5552c8 + '\x27');
    return this.getAudio("default.wav");
};
_0x34262c.prototype.getSpatialAudio = function(_0x22c6ba, _0x4fe2b6, _0x2762d7, _0x4ab031) {
    switch (_0x4ab031) {
        case "effect":
    ...
    _0x37bd58.menu.warn.show("Failed to load sound: '" + _0x22c6ba + '\x27');
    return this.getSpatialAudio("multi/default.wav");
};
_0x34262c.prototype.destroy = function() {
    ...
    for (var _0x498ee4 = this.context, _0x3a22b2 = this.resource.getTexture("map"), _0x5432e0 = this.game.getZone(), _0x19d8bf = _0x5432e0.dimensions(), _0x366f4a = this.canvas.width / _0x2c5742.TEXRES * 0.55 / this.camera.scale, _0x27c82d = Math.max(0x0, Math.min(_0x19d8bf.x, parseInt(this.camera.pos.x - _0x366f4a))), _0x19d8bf = Math.max(0x0, Math.min(_0x19d8bf.x, parseInt(this.camera.pos.x + _0x366f4a))), _0x366f4a = 0x0; _0x366f4a < _0x5432e0.data.length; _0x366f4a++)
        for (var _0x2d4c21 = _0x5432e0.data[_0x366f4a], _0x4fb7c0 = _0x27c82d; _0x4fb7c0 < _0x19d8bf; _0x4fb7c0++) {
            ...
            if (_0x2d62c4.depth === _0x5eea15) {
                var _0x59ebb0 = _0x33a76c.sprite.getSprite(_0x3a22b2, _0x2d62c4.index),
                    _0x3acdc5 = 0x0,
...
_0x642743.prototype.doNET001 = function(_0xf7e5ad) {
    ...
    this.ready = !0x0;
    _0x37bd58.menu.game.show();
};
_0x642743.prototype.doNET010 = function(_0x48cbe4) {
    if (_0x48cbe4.pid !== this.pid) {
        var _0x5c28cd = this.createObject(_0x27b379.ID, _0x48cbe4.level, _0x48cbe4.zone, _0xdd5628.decode(_0x48cbe4.pos), [_0x48cbe4.pid]);
        _0x5c28cd.setState(_0x27b379.SNAME.GHOST);
...
_0x642743.prototype.doNET017 = function(_0x17186e) {
    ...
    Cookies.set("heated_gamer_moments", _0x17186e ? parseInt(_0x17186e) + 0x1 : 0x1, {
        'expires': 0x16d
    });
};
_0x642743.prototype.doNET018 = function(_0xb678cc) {
    if (!(0x0 >= _0xb678cc.result)) {
        ...
        _0xb678cc.pid === this.pid && ((_0x11f856 = this.getPlayer()) && _0x11f856.axe(_0xb678cc.result), this.victory = _0xb678cc.result, 0x1 === _0xb678cc.result && (_0xb678cc = Cookies.get("epic_gamer_moments"), Cookies.set("epic_gamer_moments", _0xb678cc ? parseInt(_0xb678cc) + 0x1 : 0x1, {
            'expires': 0x16d
        })));
    }
};
...
_0x642743.prototype.doSpawn = function() {
    if (!this.getPlayer()) {
        ...
        this.createObject(_0x27b379.ID, _0x305400.level, _0x305400.id, _0xdd5628.decode(_0xfcde23), [this.pid]);
...
_0x642743.prototype.doPush = function() {
    ...
    this.out = [];
    _0x37bd58.net.sendBinary(_0x47ddfe);
};
...
_0x642743.prototype.coinage = function() {
    ...
    Cookies.set("dosh", _0x27d445 ? parseInt(_0x27d445) + 0x1 : 0x1, {
        'expires': 0x16d
    });
};
...
function _0x2a0e1a(_0x5a8616) {
    ...
    if (_0x37bd58.audioElement !== undefined) {
        _0x37bd58.audioElement.setAttribute('src', LOBBY_MUSIC_URL);
        _0x37bd58.audioElement.load;
        _0x37bd58.audioElement.volume = 0.18;
        _0x37bd58.audioElement.loop = true;
...
_0x2a0e1a.prototype.destroy = function() {
    ...
    if (_0x37bd58.audioElement !== undefined) {
        _0x37bd58.audioElement.pause();
        _0x37bd58.audioElement.remove();
        _0x37bd58.audioElement = undefined;
    }
}
"use strict";
...
function _0x5eee7d() {
    this.menu = new _0xb00dea();
    this.net = new _0x93c9eb();
...
_0x5eee7d.prototype.init = function() {
    var _0x210c2d = this;
    this.menu.disclaim.show();
    setTimeout(function() {
        _0x210c2d.menu.load.show();
        $.ajax({
            'url': "/royale/status?v=" + new Date().getTime(),
            'type': "GET",
            'timeout': 0xbb8,
            'success': function(_0x497cbd) {
                _0x497cbd.result ? _0x210c2d.menu.error.show(_0x497cbd.result) : _0x210c2d.menu.main.show(_0x497cbd.active);
            },
            'error': function() {
...
_0x5eee7d.prototype.load = function(_0x252dc7) {
...
_0x5eee7d.prototype.ingame = function() {
    return !!this.game;
};
_0x5eee7d.prototype.join = function(_0x8e9f8f, _0x5a204e) {
    this.ingame() ? this.menu.error.show("An error occured while starting game...") : (this.menu.load.show(), this.net.connect(_0x8e9f8f, _0x5a204e));
};
_0x5eee7d.prototype.close = function() {
    this.menu.load.show();
    this.ingame() && this.net.close();
    location.reload();
};
var _0x37bd58 = new _0x5eee7d();
_0x37bd58.init();
