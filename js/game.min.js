...
Display.prototype.drawUI = function() {
    ...
    0x3 >= this.game.victory && 0 !== this.game.victory ? (
        ...
        this.game.victory == 1 ? (
            vicAnim = Math.max(201, Math.min(255, this.game.frame % 60 >= 30 ? 255 - (this.game.frame % 30)*1.8 : 201 + (this.game.frame % 30)*1.8)),
        ...
        txt = "#" + this.game.victory,
        context.fillText(txt, 0.5 * canvasWidth - vicTexW * 0.5 + 40 * scale, 60 * scale + 0.5 * vicTexH - 32 * scale))
    ...
    : (context.fillStyle = "white",
        ...
        : this.game instanceof LobbyGame && (
            txt = this.game.players.length + (this.game.touchMode ? '' : " / 25 PLAYERS"),
            txtWidth = context.measureText(txt).width,
            context.fillText(txt, canvasWidth - txtWidth - 0x8, 0x20)
        ), 
