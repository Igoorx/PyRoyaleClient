...
PlayerObject.prototype.step = function() {
    0x0 < this.starTimer && (this.starTimer--, 30 < this.starTimer || (this.starMusic && (this.starMusic.stop(), this.starMusic = void 0x0)));
...
PlayerObject.prototype.pole = function(_0x4a8021) {
    this.autoTarget || (this.setState(PlayerObject.SNAME.POLE), this.fallSpeed = this.moveSpeed = 0x0, this.starTimer = 0x0, this.pos.x = _0x4a8021.x, this.poleTimer = 0xf, this.poleSound = !0x1);
};
